...
/*
$query = "SELECT  tb_detail_grandtotal_rincian.nomor_surat_sppd, tb_detail_grandtotal_rincian.nip, grand_total 

FROM tb_input_sppdbaru

join  

tb_detail_grandtotal_rincian

WHERE 

tb_input_sppdbaru.nomor_surat_sppd = tb_detail_grandtotal_rincian.nomor_surat_sppd 

and

tb_detail_grandtotal_rincian.nomor_surat_sppd = :nomor_sppd 

and

tb_input_sppdbaru.nomor_surat_sppd = :nomor_sppd ";
*/
      $yang_di_query = array(
 ...
 // aplikasinya dengan metode die();
	...
	$query_update = "UPDATE tb_input_sppdbaru SET status_rincian_biaya = 'SUDAH' WHERE nomor_surat_sppd = :nomor_sppd" ;
	...
	/*
	$query1 = "insert into tb_perincian_biaya
		
		(nomor_surat_sppd, nip, rincian_biaya, jumlah, tgl_pembuatan_rincian ) 
	...
	$simpan_grandtotal = "insert into tb_detail_grandtotal_rincian

		(nomor_surat_sppd, nip, grand_total ) 
		values 
		( :nomor_sppd, :nip, :grand_total)";

	

	$array_simpan_grandtotal = array(
	...
	/* // DIMATIKAN SEMENTARA
		...
		$statement_simpan   = $db->prepare($simpan_grandtotal);

        	$hasilnya = $statement_simpan->execute($array_simpan_grandtotal);
