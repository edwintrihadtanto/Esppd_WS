...
$query      = mysqli_query($con,"SELECT * FROM tb_spt where id_spt='$idspt'");
...
}else if ($ttd['nip']=='19640916 198903 2 010'){    //dr. nunik -- PENUNJANG
	echo"
<p class='contoh2'>
<table border='0'>
  <tr>
...
}else if ($ttd['nip']=='19680827 200604 2 008'){ //ratih kabag umum 
	echo"
