...
(function (global, factory) {
  ...
  var SELECTOR_TAB_CONTENT = SELECTOR_CONTENT_WRAPPER + ".iframe-mode .isi_judul_panel"; 
  var SELECTOR_TAB_EMPTY = SELECTOR_TAB_CONTENT + " .tab-empty";
  var SELECTOR_TAB_LOADING = SELECTOR_TAB_CONTENT + " .tab-loading";
  var SELECTOR_TAB_PANE = SELECTOR_TAB_CONTENT + " .tab-pane";
  //var SELECTOR_SIDEBAR_MENU_ITEM = '.main-sidebar .nav-item > a.nav-link';
  //var SELECTOR_SIDEBAR_MENU_ITEM = '.panggilan .nav-item > a.nav-link';
  var SELECTOR_SIDEBAR_MENU_ITEM = '.panggilan';
  var SELECTOR_SIDEBAR_SEARCH_ITEM = '.sidebar-search-results .list-group-item';
  var SELECTOR_HEADER_MENU_ITEM = '.main-header .nav-item a.nav-link';
  var SELECTOR_HEADER_DROPDOWN_ITEM = '.main-header';
  // var SELECTOR_HEADER_DROPDOWN_ITEM = '.main-header a.dropdown-item'; EDWIN
  ...
  var IFrame = /*#__PURE__*/function () {
    ...
    _proto.onTabClick = function onTabClick(item) {
      ...
      // $('#nama_tabpanel').val('view'+uniqueName);
    };
    ...
    _proto.createTab = function createTab(title, link, uniqueName, autoOpen) {
      ...
      var viewuniqueName = "view" + uniqueName;
      ...
      var newNavItem = "<li class=\"nav-item\" role=\"presentation\" onclick=\"" + getname(viewuniqueName) + "\" id=\"" + viewuniqueName + "\" ><a href=\"#\" class=\"btn-iframe-close\" data-widget=\"iframe-close\" data-type=\"only-this\"><i class=\"fas fa-times\"></i></a><a class=\"nav-link\" data-toggle=\"row\" id=\"" + navId + "\" href=\"#" + tabId + "\" role=\"tab\" aria-controls=\"" + tabId + "\" aria-selected=\"false\">" + title + "</a></li>";
      $__default["default"](SELECTOR_TAB_NAVBAR_NAV).append(unescape(escape(newNavItem)));
      // var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"><iframe src=\"" + link + "\"></iframe></div>";
      // $__default["default"](SELECTOR_TAB_CONTENT).append(unescape(escape(newTabItem)));
      var newTabItem = "<div class=\"tab-pane fade\" id=\"" + tabId + "\" role=\"tabpanel\" aria-labelledby=\"" + navId + "\"></div>";//<label>" + uniqueName + "</label>
      $__default["default"](SELECTOR_TAB_CONTENT).append(unescape(escape(newTabItem)));
      //SELECTOR_TAB_CONTENT = .content-wrapper .iframe-mode .tab-content      
      //alert('#'+tabId);
          ...
          $__default["default"](tabId + " iframe").ready(function () {
            if (typeof _this._config.loadingScreen === 'number') {
              ...
              setTimeout(function () {
                ...
                $('#panel-'+uniqueName).load(uniqueName);
      ...
      if (viewuniqueName == "viewlistpasienermirna"){
      }else if (viewuniqueName == "viewinputpembedahan"){
      }else if (viewuniqueName == "viewinstruksipembedahan"){
      }else if (viewuniqueName == "viewserahterima"){
      }else if (viewuniqueName == "viewchecklistkeselamatanop"){
      }else if (viewuniqueName == "viewsuratlahir"){
      }else if (viewuniqueName == "viewasuhanperioperatif"){
      }else if (viewuniqueName == "viewsuratkematian"){
      }else if (viewuniqueName == "viewsuratsehat"){
      }else if (viewuniqueName == "viewsuratsakit"){
      }else if (viewuniqueName == "viewterimapasien"){
      }else if (viewuniqueName == "viewRencanaPembedahan"){
      }else if (viewuniqueName == "viewassesmenAnak"){
      }else if (viewuniqueName == "viewassesmentNeonatus"){
      }else if (viewuniqueName == "viewpemberianinfotindakanmedis"){
      }else{
        tutupdetailpasien();
      }
    };
    ...
    _proto.removeActiveTab = function removeActiveTab(type, element) {
      if (type == 'all') {
        ...
        if ($__default["default"](SELECTOR_TAB_CONTENT).children().length == $__default["default"](SELECTOR_TAB_EMPTY + ", " + SELECTOR_TAB_LOADING).length) {
          ...
          var id = $navItemParent.children().eq(prevNavItemIndex)[0].id;
          myFunction(id);
        }
      } else {
