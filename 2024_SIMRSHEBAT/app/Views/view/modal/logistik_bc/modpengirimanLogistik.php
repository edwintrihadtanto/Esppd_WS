            ...
            <div class="modal-content" style="overflow: auto;">
                ...
                <div class="card card-row">
                    ...
                    <div class="card-header p-1 darkgrey-custom">
                        ...
                        <button type="button" class="btn bg-gradient-warning btn-xs" onclick="ModPengirimanLogistik_kembalikeawal()"><i class="fa fa-paper-plane"></i> Kirim Unit</button>
                        ...
                        <input type="number" class="form-control form-control-xs" id="ModPengirimanLogistik_penentu_resepobat" value="0" disabled hidden>
...
<script>
    ...
    function getUnit() {
        apiPOST('Logistik/getUnit', null, hasil => {
            var data = '';
            var a = hasil['data'];
            for (var i = 0; i < a.length; i++) {
                data += '<option value="' + a[i]['id_unit'] + '">' + a[i]['nama_unit'] + '</option>';
            }
        ...
        apiPOST('Logistik/getlistPermintaanLogistik', param, hasil => {
            if (hasil['data'] != null) {
                ...
                for (var i = 0; i < 1; i++) {
                    ...
                    document.getElementById("ModPengirimanLogistik_dari").value = data[i]['id_unit_dari'];
                    document.getElementById("ModPengirimanLogistik_ke").value = data[i]['id_unit_ke'];
                ...
                for (var i = 0; i < a.length; i++) {
                    ...
                    Baris += "</td>";
                    Baris += "<td>";
                    Baris += "<input type='text' class='form-control form-control-xs' name='permintaanLogistik_qtyacc[]' value='" + a[i]['qty'] + "' disabled>";
                    Baris += "</td>";
    ...
    function listBarang_ModPengirimanLogistik() {
        ...
        /* kd_barangLogistik.onPilih(() => {
            $("#ModPengirimanLogistik_qty").trigger('focus');
            $("#ModPengirimanLogistik_qty").val(1);
        }); */
    ...
    function list_ModPengirimanLogistik(kode_brgLogistik, nm_brgLogistik, qty, qtyacc, harga_beli) {
        ...
        Baris += "</td>";
        Baris += "<td>";
        Baris += "<input type='text' class='form-control form-control-xs' name='permintaanLogistik_qtyacc[]' value='" + qtyacc + "' disabled>";
        Baris += "</td>";
        Baris += "<td style='display:none;'>";
        Baris += "</td>";
        Baris += "</tr>";
    ...
    function ModPengirimanLogistik_simpan() {
        ...
        var param = {
            ...
            tglorder: document.getElementById("ModPengirimanLogistik_tglorder").value,
            dari: document.getElementById("ModPengirimanLogistik_dari").value,
            ke: document.getElementById("ModPengirimanLogistik_ke").value,
            ket: document.getElementById("ModPengirimanLogistik_ket").value,
    ...
    function ModPengirimanLogistik_kembalikeawal() {
        var idbarang = document.getElementById("ModPengirimanLogistik_idbarang").value;
        if (idbarang == '') {
            pertanyaan.fire({
