            ...
            <div class="modal-content" style="overflow: auto;">
                        ...
                        <div class="info-box mb-0">
                            <table class="table table-striped table-sm" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td><input type="text" class="form-control form-control-xs" id="ModPembelianLogistik_kasBank"></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="card card-row">
                    ...
                    <div class="card-header p-1 darkgrey-custom">
                        ...
                        <input type="number" class="form-control form-control-xs" id="ModPembelianLogistik_penentu_resepobat" value="0" disabled hidden>
                    ...
                    <div class="modal-body p-1">
                        <div class="card-body p-0">
                            <div class="col-sm-12 p-1" style="max-height: 238px; overflow-x: hidden;">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" id="ModPembelianLogistik_daftrabarang" class="table table-striped table-sm choose">
                                    <thead>
                                        <tr>
                    ...
                    <div class="card-footer p-1">
                        <div class="input-group" style="justify-content: right; font-weight: bold;">
                            <h4>Rp.&nbsp;</h4>
                            <h4 id="VModPembelianLogistik_hargatotal" name="VModPembelianLogistik_hargatotal"></h4>
                        </div>
                    </div>
...
<script>
            ...
            if (event.keyCode == 13) {
                ...
                if (kode_brgLogistik != null) {
                    if ((qty != '0') || (qty != '') || (exp_brgLogistik != '')) {
                        tampilkan_barangLogistik(kode_brgLogistik, nm_brgLogistik, qty, exp_brgLogistik, ket, harga_beli);
    ...
    function tampilkan_barangLogistik(kode_brgLogistik, nm_brgLogistik, qty, exp_brgLogistik, ket, harga_beli) {
        ...
        Baris += "</td>";
        Baris += "<td>";
        Baris += "<input type='text' class='form-control form-control-xs' name='pembelianLogistik_harga_beli[]' value='" + format_ribuan(parseInt(harga_beli)) + "' disabled>";
        Baris += "</td>";
        Baris += "<td>";
    ...
    function editbaris_pembelianLogistik(btn, nomor) {
        ...
        var exp = document.getElementById("ModPembelianLogistik_daftrabarang").rows[nomor].cells[5].firstChild.value;
        var ket = document.getElementById("ModPembelianLogistik_daftrabarang").rows[nomor].cells[7].firstChild.value;
    ...
    function hapusbaris_pembelianLogistik(btn, nomor) {
        ...
        let total = 0;
        var qty = document.getElementById("ModPembelianLogistik_daftrabarang").rows[nomor].cells[4].firstChild.value;
        var hrg_beli = document.getElementById("ModPembelianLogistik_daftrabarang").rows[nomor].cells[6].firstChild.value;
        var totalx = document.getElementById("ModPembelianLogistik_hargatotal").value;
