            ...
            <div class="modal-content" style="overflow: auto;">
                        ...
                        <div class="info-box mb-0">
                            <table class="table table-striped table-sm" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="70">Dari</td>
                                    <td>:</td>
                                    <td><select type="text" class="form-control form-control-xs" id="ModPermintaanLogistik_dari"></select></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                        ...
                        <div class="info-box mb-0">
                            <table class="table table-striped table-sm" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td width="70">Ke</td>
                                    <td>:</td>
                                    <td><select type="text" class="form-control form-control-xs" id="ModPermintaanLogistik_ke"></select></td>
                                </tr>
                            </table>
                        </div>
                    </div>
                ...
                <div class="card card-row">
                    ...
                    <div class="card-header p-1 darkgrey-custom">
                        ...
                        <input type="number" class="form-control form-control-xs" id="ModPermintaanLogistik_penentu_resepobat" value="0" disabled hidden>
...
<script>
    ...
    function ModPermintaanLogistik_kembalikeawal() {
        var idbarang = document.getElementById("ModPermintaanLogistik_idbarang").value;
        if (idbarang == '') {
            pertanyaan.fire({
