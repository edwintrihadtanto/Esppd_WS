        ...
        <div class="modal-dialog modal-xl" style="min-width: 100%;">
            ...
            <div class="modal-content" style="overflow: auto;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="0" class="form-control form-control-xs" id="ModPembelianLogistik_inputpotongan" disabled>
                                        </div>
                                    </td>
                                    <td>PPN</td>
                                    <td>:</td>
                                    <td>
                                        <div class="input-group">
                                            <input type="text" value="0" class="form-control form-control-xs" id="ModPembelianLogistik_inputppn" disabled>
                                            <div class="input-group-prepend">
                                    ...
                                    <td colspan="6" class="text-right">
                                        <button type="button" class="btn bg-gradient-primary btn-xs" id="ModPembelianLogistik_btnpotonganfalse" onclick="showmodalBiayaLainModpbllog()"><i class="fa fa-edit"></i></button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Biaya Lain</td>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="0" class="form-control form-control-xs" id="ModPembelianLogistik_inputbiayalain" disabled>
                                        </div>
                                    </td>
                                    <td>Ongkos Kirim</td>
                                    <td>:</td>
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="0" class="form-control form-control-xs" id="ModPembelianLogistik_inputongkoskirim" disabled>
                                        </div>
                                    </td>
                                </tr>
                                <!-- <tr>
                                    <td colspan="6" class="text-right">
                                        <button type="button" class="btn bg-gradient-primary btn-xs" id="ModPembelianLogistik_btnpotonganfalse" onclick="showmodalBiayaLainModpbllog()(false)"><i class="fa fa-edit"></i></button>
                                    </td>
                                </tr> -->
                                <!-- <tr>
                                    <td width="70">Ongkos Kirim</td>
                                    <td>:</td>
                                    <td>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control form-control-xs" id="ModPembelianLogistik_inputongkoskirim" disabled>
                                        </div>
                                    </td>
                                </tr> -->
                                <!-- <tr>
                ...
                <div class="card card-row">
                    ...
                    <div class="modal-body p-1">
                            ...
                            <div class="col">
                                <div class="row mb-1" id="ModPembelianLogistik_inputPembelian">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text form-control-xs">Hrg. Beli</span>
                                            </div>
                                            <input type="text" class="form-control form-control-xs" id="ModPembelianLogistik_hargaBeli">
                                        </div>
                                    </div>
                                    <div class="col-sm-1">
                                        <div class="input-group">
                        ...
                        <div class="row">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" id="ModPembelianLogistik_daftrabarang" class="table table-striped table-sm choose text-nowrap">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="pl-0" width="20" style="text-align:center;">Qty</th>
                                                            <th class="pl-0" width="50" style="text-align:center;">Diskon</th>
                            ...
                            <div class="col-2 p-1">
                                <div class="row">
                                    <div class="col">
                                        <table border="0" cellpadding="0" cellspacing="0" class="table table-striped table-sm choose text-nowrap">
                                            <thead>
                                                <tr>
                                                    <th colspan="7"></th>
                                                    <th class="text-right" width="100">Sub Total : Rp.</th>
                                                    <th id="VModPembelianLogistik_subtotal">0</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7"></th>
                                                    <th class="text-right" width="100">Sub Diskon : Rp.</th>
                                                    <th id="VModPembelianLogistik_totaldiskon">0</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7"></th>
                                                    <th class="text-right" width="100">Jumlah : Rp.</th>
                                                    <th id="VModPembelianLogistik_hargatotal">0</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7"></th>
                                                    <th class="text-right" width="100">Potongan : Rp.</th>
                                                    <th id="VModPembelianLogistik_Potongan">0</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7"></th>
                                                    <th class="text-right" width="100">PPN : Rp.</th>
                                                    <th id="VModPembelianLogistik_ppn">0</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7"></th>
                                                    <th class="text-right" width="100">Biaya Lain : Rp.</th>
                                                    <th id="VModPembelianLogistik_biayalain">0</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7"></th>
                                                    <th class="text-right" width="100">Ongkos Kirim : Rp.</th>
                                                    <th id="VModPembelianLogistik_ongkoskirim">0</th>
                                                </tr>
                                                <tr>
                                                    <th colspan="7"></th>
                                                    <th class="text-right" width="100">
                                                        <hr>Grand Total : Rp.</th>
                                                    <th id="VModPembelianLogistik_grandtotal">0</th>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
                    ...
                    <input type="text" value="0" id="ModPembelianLogistik_ppnrp" name="ModPembelianLogistik_ppnrp" disabled hidden>
                </div>
            </div>
        </div>
    </div>
...
<div class="content modal fade" id="modal_BiayaLainModpbllog">
    <div class="container-fluid">
        <div class="modal-dialog modal-md">
            ...
            <div class="modal-content">
                <div class="row p-1">
                    <div class="col">
                        <button type="button" class="btn btn-outline-danger btn-xs" onclick="keluar_modal_BiayaLainModpbllog()"><i class="fa fa-arrow-left"></i> Kembali</button>
                        <button type="button" class="btn btn-outline-primary btn-xs" onclick="simpan_modal_BiayaLainModpbllog()"><i class="fa fa-check"></i> Simpan</button>
                    </div>
                </div>
                <div class="row p-1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="0" class="form-control form-control-xs" id="modal_BiayaLainModpbllog_inputpotongan">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input type="text" value="0" class="form-control form-control-xs" id="modal_BiayaLainModpbllog_inputppn">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text form-control-xs">%</span>
                                            </div>
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="0" class="form-control form-control-xs" id="modal_BiayaLainModpbllog_inputbiayalain">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="0" class="form-control form-control-xs" id="modal_BiayaLainModpbllog_inputongkoskirim">
                                        </div>
                                    </td>
                                </tr>
                            </table>
...
<script>
    ...
    function showmodalBiayaLainModpbllog() {
        $("#modal_BiayaLainModpbllog").modal({
            backdrop: "static"
        });
        $('#modal_BiayaLainModpbllog').on('shown.bs.modal', function() {
            $("#modal_BiayaLainModpbllog_inputpotongan").trigger('focus');

            var potongan = document.getElementById("ModPembelianLogistik_inputpotongan").value;
            var ppn = document.getElementById("ModPembelianLogistik_inputppn").value;
            var biayalain = document.getElementById("ModPembelianLogistik_inputbiayalain").value;
            var ongkoskirim = document.getElementById("ModPembelianLogistik_inputongkoskirim").value;

            document.getElementById("modal_BiayaLainModpbllog_inputpotongan").value = potongan;
            document.getElementById("modal_BiayaLainModpbllog_inputppn").value = ppn;
            document.getElementById("modal_BiayaLainModpbllog_inputbiayalain").value = biayalain;
            document.getElementById("modal_BiayaLainModpbllog_inputongkoskirim").value = ongkoskirim;
        });

    }

    function keluar_modal_BiayaLainModpbllog() {
        $('#modal_BiayaLainModpbllog').modal('hide');
    }

    function simpan_modal_BiayaLainModpbllog() {
        var total = document.getElementById("ModPembelianLogistik_hargatotal").value;
        var cekpotongan = document.getElementById("modal_BiayaLainModpbllog_inputpotongan").value;
        var cekppn = document.getElementById("modal_BiayaLainModpbllog_inputppn").value;
        var cekbiayalain = document.getElementById("modal_BiayaLainModpbllog_inputbiayalain").value;
        var cekongkoskirim = document.getElementById("modal_BiayaLainModpbllog_inputongkoskirim").value;
        ...
        if (cekongkoskirim != '') {
            var ongkoskirim = cekongkoskirim;
        } else {
            var ongkoskirim = '0';
        }

        document.getElementById("ModPembelianLogistik_inputpotongan").value = potongan;
        document.getElementById("ModPembelianLogistik_inputppn").value = ppnx;
        document.getElementById("ModPembelianLogistik_inputbiayalain").value = biayalain;
        document.getElementById("ModPembelianLogistik_inputongkoskirim").value = ongkoskirim;
        grandtotal = (parseInt(total) - parseInt(potongan)) + parseInt(ppn) + parseInt(biayalain) + parseInt(ongkoskirim);
        ...
        document.getElementById("ModPembelianLogistik_ppnrp").value = ppn;
        document.getElementById("VModPembelianLogistik_biayalain").innerHTML = format_ribuan(biayalain);
        document.getElementById("VModPembelianLogistik_ongkoskirim").innerHTML = format_ribuan(cekongkoskirim);
        ...
        apiPOST('Logistik/getlistPembelianLogistik', param, hasil => {
            if (hasil['data'] != null) {
                ...
                for (var i = 0; i < 1; i++) {
                    ...
                    document.getElementById("ModPembelianLogistik_inputpotongan").value = data[i]['potongan'];
                    document.getElementById("ModPembelianLogistik_inputppn").value = data[i]['ppn'];
                    document.getElementById("ModPembelianLogistik_inputbiayalain").value = data[i]['biaya_lain'];
                    document.getElementById("ModPembelianLogistik_inputongkoskirim").value = data[i]['ongkir'];
                }
                ...
                for (var i = 0; i < a.length; i++) {
                    ...
                    Baris += "</td>";
                    Baris += "<td>";
                    Baris += "<input type='text' class='form-control form-control-xs' name='pembelianLogistik_disc[]' value='" + a[i]['diskon'] + "' disabled>";
                    Baris += "</td>";
                    Baris += "<td>";
    ...
    function getBarang_ModPembelianLogistik() {
        ...
        apiPOST('Logistik/getBarangLogistik', param, hasil => {
            if (hasil !== null) {
                var list = hasil['data'];
                list.forEach(item => {
                    kd_barangLogistik.addData([item['id_barang_logistik'], item['harga_beli']], item['nama_barang']);
                });
            }
        });
    }
    ...
    function listBarang_ModPembelianLogistik() {
        ...
        kd_barangLogistik.onPilih(() => {
            var hrgBeli = kd_barangLogistik.getValue()[1];
            $("#ModPembelianLogistik_hargaBeli").trigger('focus');
            $("#ModPembelianLogistik_hargaBeli").val(hrgBeli);
        });

        $("#ModPembelianLogistik_hargaBeli").on("keyup", function(event) {
            if (event.keyCode == 13) {
        ...
        $("#ModPembelianLogistik_qty").on("keyup", function(event) {
            if (event.keyCode == 13) {
                ...
                $("#ModPembelianLogistik_diskon").val(0);
            }
        });
        ...
        $("#ModPembelianLogistik_ket").on("keyup", function(event) {
            if (event.keyCode == 13) {
                ...
                var harga_beli = document.getElementById("ModPembelianLogistik_hargaBeli").value;
                ...
                if (kode_brgLogistik != null) {
                    if ((qty != '0') && (qty != '') && (exp_brgLogistik != '')) {
                        tampilkan_barangLogistik(kode_brgLogistik, nm_brgLogistik, qty, exp_brgLogistik, ket, harga_beli, cekdiskon, potongan, ppn, biayalain, ongkoskirim);
    ...
    function tampilkan_barangLogistik(kode_brgLogistik, nm_brgLogistik, qty, exp_brgLogistik, ket, harga_beli, cekdiskon, potongan, ppn, biayalain, ongkoskirim) {
        ...
        Baris += "</td>";
        Baris += "<td>";
        Baris += "<input type='text' class='form-control form-control-xs' name='pembelianLogistik_disc[]' value='" + cekdiskon + "' disabled>";
        Baris += "</td>";
        Baris += "<td>";
        ...
        if (status_kd_BrgLogistik == false) {
            ...
            grandtotal = (parseInt(total) - parseInt(potongan)) + parseInt(cekppn) + parseInt(biayalain) + parseInt(ongkoskirim);
            ...
            document.getElementById("VModPembelianLogistik_biayalain").innerHTML = format_ribuan(biayalain);
            document.getElementById("ModPembelianLogistik_ppnrp").value = cekppn;
    ...
    function kosongInputPembelianLogistik() {
        ...
        document.getElementById("ModPembelianLogistik_hargaBeli").value = '';
    ...
    function editbaris_pembelianLogistik(btn, nomor) {
        ...
        var hargaBeli = document.getElementById("ModPembelianLogistik_daftrabarang").rows[nomor].cells[7].firstChild.value;
        var ket = document.getElementById("ModPembelianLogistik_daftrabarang").rows[nomor].cells[8].firstChild.value;

        $("#ModPembelianLogistik_hargaBeli").trigger('focus');

        cekdiskon = (parseInt(disc) * 100) / hargaBeli

        /* 30 / 100 * 250.000 = 75.000
        ...
        document.getElementById("ModPembelianLogistik_diskon").value = cekdiskon;
        document.getElementById("ModPembelianLogistik_exp").value = exp;
        document.getElementById("ModPembelianLogistik_hargaBeli").value = hargaBeli;
    ...
    function hapusbaris_pembelianLogistik(btn, nomor) {
        ...
        total = parseInt(subtotal) - parseInt(totaldiskon);
        cekppn = parseInt(total) * (ppn / 100);
        grandtotal = (parseInt(subtotal) - parseInt(totaldiskon)) - parseInt(potongan) + (parseInt(cekppn) + parseInt(ongkoskirim) + parseInt(biayalain));
        document.getElementById("ModPembelianLogistik_subtotal").value = subtotal;
        document.getElementById("VModPembelianLogistik_subtotal").innerHTML = format_ribuan(subtotal);
        document.getElementById("ModPembelianLogistik_hargatotal").value = total;
        document.getElementById("VModPembelianLogistik_hargatotal").innerHTML = format_ribuan(total);
    ...
    function params_pembelianLogistik() {
        ...
        var getdisc = document.getElementsByName('pembelianLogistik_disc[]');
    ...
    function ModPembelianLogistik_simpan() {
        ...
        var cekppn = document.getElementById("ModPembelianLogistik_ppnrp").value;
        if (cekppn != '') {
            var ppn = cekppn;
        } else {
            var ppn = '0';
        ...
        a = document.getElementById("supplier_logistik_ModPembelianLogistik");
        var nm_sup = a.options[a.selectedIndex].text;
        ...
        var param = {
            ...
            ptg: potongan,
            ppn: ppn,
            ppnpersen: document.getElementById("ModPembelianLogistik_inputppn").value,
            biayalain: document.getElementById("ModPembelianLogistik_inputbiayalain").value,
            ongkoskirim: document.getElementById("ModPembelianLogistik_inputongkoskirim").value,
            nm_sup: nm_sup,
            jumlahtotal: document.getElementById('ModPembelianLogistik_hargatotal').value,
            grandtotal: document.getElementById('ModPembelianLogistik_grandtotal').value,
