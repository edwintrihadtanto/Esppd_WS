...
?>
<!-- <section class="content pb-0" id="erm_eresepGab_content"> -->
      ...
      <div class="modal-dialog modal-xl" style="min-width: 100%;">
        ...
        <div class="modal-content" style="overflow: auto;">
            ...
            <div class="row p-1">
              <div class="col-sm-4 mb-0">
                <div class="form-group row mb-1">
                  <label for="erm_eresepGab_idresep" class="col-sm-4">Id.OrderResep</label>
                  <div class="input-group col-sm-8">
                    <input type="text" class="form-control form-control-xs" id="erm_eresepGab_idresep" name="erm_eresepGab_idresep" disabled>
                    <div class="input-group-prepend">
                      <button type="button" class="btn btn-danger btn-xs" id="erm_eresepGab_btnhpus_order" onclick="erm_eresepGab_hpus_order()"><i class="fa fa-trash"></i></button>
                    </div>
                  </div>                  
                </div>
                <div class="form-group row mb-1">
                  <label for="erm_eresepGab_tglresep" class="col-sm-4">Tanggal</label>
                  <div class="col-sm-8">
                    <input type="date" class="form-control form-control-xs" id="erm_eresepGab_tglresep" name="erm_eresepGab_tglresep">
                  </div>
                </div>
                <div class="form-group row mb-1">
                  <label for="erm_eresepGab_dokter" class="col-sm-4">Dokter</label>
                  <div class="col-sm-8">
                    <!-- <input type="text" class="form-control form-control-xs" id="erm_eresepGab_dokter" name="erm_eresepGab_dokter" disabled> -->
                    <select class="form-control form-control-xs" id="erm_eresepGab_dokter" name="erm_eresepGab_dokter" required ></select>
                  </div>
                </div>
                <div class="form-group row mb-1">
                  <label class="col-sm-4">Jenis Resep</label>
                  <div class="col-sm-8">
                    <select class="form-control form-control-xs" id="erm_eresepGab_jenisresep">
                ...
                <div class="form-group row mb-1" style="display: none;">
                  ...
                  <h5 class="col-sm-6" id="verm_eresepGab_grandtotal" style="text-align:right; font-weight: bold;" >0</h5>
                  <input type="text" value="0" class="form-control form-control-xs" id="erm_eresepGab_grandtotal" name="erm_eresepGab_grandtotal" disabled hidden>
              ...
              <div class="col-sm-8 mb-0">
                <div class="form-group row mb-1">
                  <label for="erm_eresepGab_diagnosa" class="col-sm-2">Diagnosa</label>
                  <div class="col-sm-10">
                    <textarea class="form-control form-control-sm" id="erm_eresepGab_diagnosa" name="erm_eresepGab_diagnosa" style="height:50px;"></textarea>
                  </div>
                </div>
                <div class="form-group row mb-1">
                  <label for="erm_eresepGab_iter" class="col-sm-2">ITER</label>
                  <div class="col-sm-10">
                    <textarea class="form-control form-control-sm" id="erm_eresepGab_iter" name="erm_eresepGab_iter" style="height:50px;"></textarea>
                  </div>
                </div>
              </div>
          ...
          <div class="card-header p-1 darkgrey-custom">
            <button type="button" class="btn btn-warning btn-xs" onclick="erm_eresepGab_history()"><i class="fa fa-list-alt"></i> History Order</button>
            <button type="button" class="btn btn-warning btn-xs" onclick="erm_eresepGab_templateresep()"><i class="fa fa-list-alt"></i> Template Resep</button>
            <button type="button" class="btn bg-gradient-secondary btn-xs" onclick="erm_eresepGab_simpanorder()"><i class="fa fa-save"></i> Simpan</button>
            <button type="button" class="btn bg-gradient-danger btn-xs" onclick="preview_detailObat()"><i class="fa fa-arrow-right"></i> Kirim ke Unit Farmasi</button>
            <button type="button" class="btn btn-info btn-xs" onclick="getData_erm_eresepGab()">
              <i class="fa fa-sync-alt fa-spin"></i> Refresh Data</button>
            <button type="button" class="btn btn-outline-danger btn-xs" onclick="erm_eresepGab_kembalikeawal()">
              <i class="fa fa-arrow-left"></i> Kembali</button>
            <div class="col-sm-1" id="erm_eresepGab_status_order_terkirim" style="display:contents;" hidden>
              <img src="<?= base_url('_assets/dist/img/checklist.png') ?>" width="23px" height="23px" title="Sudah Dikirm"/>
            </div>
            <div class="col-sm-1" id="erm_eresepGab_status_order_belumterkirim" style="display:contents;" hidden>
              <img src="<?= base_url('_assets/dist/img/cancel.png') ?>" width="21px" height="21px" title="Belum Dikirm"/>
            </div>
            <div class="col-sm-1" id="erm_eresepGab_status_dilayanitrue" style="display:contents;" hidden>
              <img src="<?= base_url('_assets/dist/img/checklist.png') ?>" width="23px" height="23px" title="Sudah Dilayani"/>
            </div>
            <div class="col-sm-1" id="erm_eresepGab_status_dilayanifalse" style="display:contents;" hidden>
              <img src="<?= base_url('_assets/dist/img/cancel.png') ?>"  width="21px" height="21px" title="Belum Dilayani"/>
            </div>

            <input type="text" class="form-control form-control-xs" id="erm_eresepGab_penentu_resepobat" value="0" disabled style="width:50px; display:none;">
          </div>
          <div class="modal-body p-1">
            ...
            <div class="card-body p-0">
              <ul class="nav nav-tabs" id="rwj_resep_custom-content-above-tab" role="tablist">
                ...
                <li class="nav-item">
                  <a class="nav-link btn-danger" data-toggle="pill" href="#" role="tab" aria-selected="true" id="erm_eresepGab_infojenis_racikan" style="font-weight: bold; color: white;">-</a>
                </li>
              </ul>
              ...
              <div class="tab-content" id="rwj_resep_custom-content-above-tabContent">
                <div class="tab-pane p-0 fade active show" id="rwj_resep_obatjadi" role="tabpanel">
                  <div class="col-sm-12 p-1" style="max-height: 323px; overflow-x: hidden;">
                    <div class="row mb-1" id="erm_eresepGab_inputan_obat_jadi">
                      <!-- <div class="col-md-3">
                        <div class="form_group">
                          <label>Pencarian Obat</label>
                          <select class="form-control form-control-xs erm_eresepGab_pencarian" id="erm_eresepGab_pencarian"></select>
                        </div>
                      </div> -->

                      <div class="input-group col-sm-3">
                        <input type="text" class="form-control form-control-xs d-none" id="erm_eresepGab_obatjadi_urut" disabled>
                        <div class="input-group-prepend">
                          <span class="input-group-text form-control-xs">Nama</span>
                        </div>
                        <input type="search" class="form-control form-control-xs" placeholder="Ketikkan Nama Obat" id="erm_eresepGab_obatjadi_nm" autocomplete="false">
                      </div>
                      <div class="col-sm-2">
                        <div class="input-group">
                          ...
                          <input type="number" class="form-control form-control-xs" id="erm_eresepGab_obatjadi_qty">
                        </div>
                      </div>
                      <div class="input-group col-sm-3">
                        <div class="input-group-prepend">
                        ...
                        <input type="search" class="form-control form-control-xs" id="erm_eresepGab_obatjadi_signa">
                      </div>
                      <div class="input-group col-sm-3">
                        <div class="input-group-prepend">
                          <span class="input-group-text form-control-xs">Ket.</span>
                        </div>
                        <input type="text" class="form-control form-control-xs" id="erm_eresepGab_obatjadi_ket">
                        <div class="input-group-prepend">
                          <button type="button" class="btn btn-primary btn-xs" id="erm_eresepGab_btn_check_obatjadi"><i class="fa fa-check"></i></button>
                          <button type="button" class="btn btn-outline-primary btn-xs" onclick="kosongObatJadi()"><i class="fa fa-file"></i> Baru</button>
                        </div>
                      </div>
                      
                    </div> 
                    <table border="0" cellpadding="0" cellspacing="0" id="erm_eresepGabtable_obatjadi" class="table table-striped table-sm choose">
                      <thead>
                        <tr>
                ...
                <div class="tab-pane p-0 fade" id="rwj_resep_obatracik" role="tabpanel">
                  <div class="col-sm-12 p-1">
                    <div class="mb-1" id="erm_eresepGab_inputan_obat_racik">
                      <div class="row" id="erm_eresepGab_inputan_obat_racik1">
                        <div class="input-group col-sm-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text form-control-xs">Racikan</span>
                          </div>
                          <input type="search" class="form-control form-control-xs" placeholder="Ketikkan Nama Racikan" id="erm_eresepGab_nmaracikan">
                        </div>
                        <div class="input-group col-sm-2">
                          <div class="input-group-prepend">
                            <span class="input-group-text form-control-xs">Banyak</span>
                          </div>
                          <input type="number" class="form-control form-control-xs" id="erm_eresepGab_bnykracikan">
                        </div> 
                        <div class="input-group col-sm-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text form-control-xs">Signa</span>
                          </div>
                          <input type="search" class="form-control form-control-xs" id="erm_eresepGab_signaracikan">
                        </div>
                        <div class="input-group col-sm-3">
                          <div class="input-group-prepend">
                            <span class="input-group-text form-control-xs">Ket.</span>
                          </div>
                          <input type="text" class="form-control form-control-xs" id="erm_eresepGab_ketracikan">
                          <div class="input-group-prepend">
                            <button type="button" class="btn btn-outline-primary btn-xs" onclick="erm_eresepGab_mulaiawalRacikan()"><i class="fa fa-file"></i> Baru</button>
                          </div>
                        </div>

                      </div>
                      <hr class="mt-2 mb-2" width="95%">
                      <div class="row" id="erm_eresepGab_inputan_obat_racik2">
                        <div class="input-group col-sm-3">
                          <input type="text" class="form-control form-control-xs d-none" id="erm_eresepGab_obat_racik_urut" disabled>
                          <div class="input-group-prepend">
                            <span class="input-group-text form-control-xs">Nama</span>
                          </div>
                          <input type="search" class="form-control form-control-xs" placeholder="Ketikkan Nama Obat" autocomplete="false" id="erm_eresepGab_obat_racik_nmaobat">
                        </div>
                        <div class="col-sm-2">
                          <div class="input-group">
                            <div class="input-group-prepend">
                            ...
                            <input type="number" class="form-control form-control-xs" id="erm_eresepGab_obat_racik_dosis">
                          </div>
                        </div>
                        <div class="col-sm-2">
                          <div class="input-group">
                            ...
                            <input type="number" class="form-control form-control-xs" id="erm_eresepGab_obat_racik_qty">
                          </div>
                        </div>
                        <div class="input-group col-sm-3">
                          <div class="input-group-prepend">
                          ...
                          <input type="text" class="form-control form-control-xs" id="erm_eresepGab_obat_racik_ket">
                          <div class="input-group-prepend">
                            <button type="button" class="btn btn-outline-primary btn-xs" id="erm_eresepGab_btn_check_obatracik"><i class="fa fa-check"></i> Pilih</button>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="row p-1">
                      <div class="col-sm-3" style="max-height: 323px; overflow: hidden;">
                        <table border="0" cellpadding="0" cellspacing="0" id="erm_eresepGabtable_obatracik_jenisracikan" class="table table-striped table-sm choose">
                        <thead>
                          <tr>
                            <th width="10">#</th>
                            <th width="80">Act</th>
                      ...
                      <div class="col-sm-9" style="max-height: 323px; overflow-x: hidden;">
                        <table border="0" cellpadding="0" cellspacing="0" id="erm_eresepGabtable_obatracik" class="table table-striped table-sm choose">
                        <thead>
                          <tr>
                            <th width="10">#</th>
                            <th width="80">Act</th>
...
kd_signaObatJadi  = new AutoCompleteObat("erm_eresepGab_obatjadi_signa");
var kd_signaObatRacik;
kd_signaObatRacik = new AutoCompleteObat("erm_eresepGab_signaracikan");
var nama_racikan;

document.getElementById('erm_eresepGab_tglresep').value = nowday;
...
function showUp_erm_eresepGab(){  
  ...
  erm_eresepGab_ObatJadi();
  erm_eresepGab_ObatRacik();
  ...
  apiPOST('Setup/getDokter', null, hasil => {
    ...
    for (var i = 0; i < data.length; i++) {
      ...
      if (data[i]['id_pegawai'] == user.id_pegawai){
        c = user.id_pegawai;
      }
    }
    document.getElementById('erm_eresepGab_dokter').innerHTML = dok;
    document.getElementById('erm_eresepGab_dokter').value   = c;
  });
}

var a = "erm_eresepGab_tglresep";
max_date(a);

function getObat_erm_eresepGab(){  
  var param = {
    obatcari: document.getElementById("erm_eresepGab_obatjadi_nm").value,
  };
  
  kd_produkObatJadi = new AutoCompleteObat("erm_eresepGab_obatjadi_nm");
  kd_produkObatRacik = new AutoCompleteObat("erm_eresepGab_obat_racik_nmaobat");
  ...
  kd_JenisRacikan = new AutoCompleteObat("erm_eresepGab_nmaracikan");
...
function getData_erm_eresepGab(){
  $('#loading_modal_erm_eresepGab').show();
  document.getElementById("erm_eresepGab_status_order_belumterkirim").hidden  = true;
  document.getElementById("erm_eresepGab_status_order_terkirim").hidden       = true;
  document.getElementById("erm_eresepGab_status_dilayanifalse").hidden        = true; 
  document.getElementById("erm_eresepGab_status_dilayanitrue").hidden         = true;
  var param = {
    idresep   : '',
  ...
  apiPOST('Apotek/getData_erm_eresepGab', param, hasil => {
    sessionStorage.clear();
    if (hasil !== null) {
      $('#loading_modal_erm_eresepGab').hide();
      if (hasil['code'] == '200'){
        var data        = hasil['data'];
        ...
        if (hasil['count'] > 1){
          toastr.warning('Terdapat Lebih dari 1 Order Resep di Tgl. '+document.getElementById('erm_eresepGab_tglresep').value);
        }else{
          $('#erm_eresepGabtable_obatjadi tbody').html('');
          $('#erm_eresepGabtable_obatracik_jenisracikan tbody').html('');
          $('#erm_eresepGabtable_obatracik tbody').html('');
          document.getElementById("erm_eresepGab_grandtotal").value = 0;

          for (var i = 0; i < data.length; i++) {
            document.getElementById("erm_eresepGab_idresep").value    = data[i].id_order;
            document.getElementById("erm_eresepGab_diagnosa").value   = data[i].cat_diagnosa;
            document.getElementById("erm_eresepGab_iter").value       = data[i].cat_iter;
            document.getElementById('erm_eresepGab_jenisresep').value = data[i].jnsresep;
            document.getElementById('erm_eresepGab_dokter').value     = data[i].id_pegawai;

            if (data[i].order_mng == 't'){
              document.getElementById("erm_eresepGab_status_order_terkirim").hidden = false;
              if (data[i].dilayani == '1'){
                document.getElementById("erm_eresepGab_status_dilayanitrue").hidden = false;
                document.getElementById("erm_eresepGab_status_dilayanifalse").hidden = true;
              }else{
                document.getElementById("erm_eresepGab_status_dilayanitrue").hidden = true;
                document.getElementById("erm_eresepGab_status_dilayanifalse").hidden = false;
              }
            }else{
              document.getElementById("erm_eresepGab_status_order_belumterkirim").hidden = false;
              document.getElementById("erm_eresepGab_status_order_terkirim").hidden = true;
              document.getElementById("erm_eresepGab_status_dilayanifalse").hidden = false; 
              document.getElementById("erm_eresepGab_status_dilayanitrue").hidden = true;         
            }
          ...
          if (GroupRacik.length > 0){
            ...
            for (var g = 0; g < GroupRacik.length; g++) {
              ...
              var Baris = "<tr>";
                 Baris += "<td>"+Nomor+"</td>";
                 Baris += '<td style="display: flex;"><button type="button" class="btn btn-xs btn-warning" title="Tampilkan '+ nama_racikan+'" onclick="tampilkan_jenisracik('+"'"+Nomor+"','"+nma_racikan+"','"+byk_racikan+"','"+sig_racikan+"','"+ket_racikan+"','"+x+"'"+')" style="width:100%"><i class="fa fa-arrow-up"></i></button><button type="button" class="btn btn-xs btn-danger" onclick="hapus_jenisracik(this, '+"'"+Nomor+"','"+nma_racikan+"','"+byk_racikan+"','"+sig_racikan+"','"+ket_racikan+"','"+nama_racikan+"'"+')" style="width:100%"><i class="fa fa-times"></i></button></td>';
            ...
            for (let a = 0; a < group_racikan.length; a++) {
              ...
              for (let i = 0; i < group_racikandriOBAT[nm_kelompok].length; i++) {
                ...
                var totalx = document.getElementById("erm_eresepGab_grandtotal").value;
                total = parseInt(totalx) + parseInt(qty);
                document.getElementById("erm_eresepGab_grandtotal").value = total;
                document.getElementById("verm_eresepGab_grandtotal").innerHTML = format_ribuan(total);
              }
            }
          }
...
function getObat_erm_eresepGab2(){
  var param = {
    obatcari: ''
  };
  ...
  apiPOST('Apotek/pencarianobat2', param, hasil => {
    ...
    document.getElementById('erm_eresepGab_pencarian').innerHTML = data;
  })

}

function erm_eresepGab_ObatJadi(){

  kd_produkObatJadi.onPilih(()=>{
    $("#erm_eresepGab_obatjadi_qty").trigger('focus');
    $("#erm_eresepGab_obatjadi_qty").val("");
  });

  $("#erm_eresepGab_obatjadi_qty").on("keyup", function(event){
    if (event.keyCode == 13) {
      $("#erm_eresepGab_obatjadi_signa").trigger('focus');
    }
  });

  $("#erm_eresepGab_obatjadi_signa").on("keyup", function(event){
    if (event.keyCode == 13) {
      $("#erm_eresepGab_obatjadi_ket").trigger('focus');
    }
  });

  $("#erm_eresepGab_obatjadi_ket").on("keyup", function(event){
    if (event.keyCode == 13) {
      var kd_obat  = kd_produkObatJadi.getValue();      
      var nm_obat = document.getElementById("erm_eresepGab_obatjadi_nm").value;
      var cekqty  = document.getElementById("erm_eresepGab_obatjadi_qty").value;
      if (cekqty != ''){
        var qty = cekqty;
      }else{
        var qty = '0';
      ...
      var signa   = document.getElementById("erm_eresepGab_obatjadi_signa").value.toUpperCase();
      var ket     = document.getElementById("erm_eresepGab_obatjadi_ket").value;
      if (kd_obat != null){
        if ((qty != '0')||(qty != '')||(signa != '')){
          if (id_signa != null){
            tampilkan_isi_obatjdi(kd_obat, nm_obat, qty, id_signa, signa, ket);
  ...
  $("#erm_eresepGab_btn_check_obatjadi").click(function( event ) {
    var kd_obat  = kd_produkObatJadi.getValue();
    var nm_obat = document.getElementById("erm_eresepGab_obatjadi_nm").value;
    var cekqty  = document.getElementById("erm_eresepGab_obatjadi_qty").value;
    if (cekqty != ''){
...
function erm_eresepGab_ObatRacik(){
  /*INPUTAN JENIS RACIKAN*/
  kd_JenisRacikan.onPilih(()=>{
    $("#erm_eresepGab_bnykracikan").trigger('focus');
    $("#erm_eresepGab_bnykracikan").val(1);
  });

  $("#erm_eresepGab_bnykracikan").on("keyup", function(event){
    if (event.keyCode == 13) {
      $("#erm_eresepGab_signaracikan").trigger('focus');
      //$("#erm_eresepGab_signaracikan").val('3x1');
    }
  });

  $("#erm_eresepGab_signaracikan").on("keyup", function(event){
    if (event.keyCode == 13) {
      $("#erm_eresepGab_ketracikan").trigger('focus');
    }
  });
  ...
  $("#erm_eresepGab_ketracikan").on("keyup", function(event){
    if (event.keyCode == 13) {
      var nma_racikan = $('#erm_eresepGab_nmaracikan').val().toUpperCase().replace(/ /gi, "_");
      var byk_racikan = $('#erm_eresepGab_bnykracikan').val();
      var id_sig_rac  = kd_signaObatRacik.getValue();
      var sig_racikan = $('#erm_eresepGab_signaracikan').val().toUpperCase();
      var ket_racikan = $('#erm_eresepGab_ketracikan').val().toUpperCase();
      if (id_sig_rac != null){
        if (nma_racikan == '' || byk_racikan == '' || sig_racikan == ''){
          toastr.error("Inputan masih kosong!!");
        }else{
          $('#erm_eresepGab_inputan_obat_racik1').show(); 
          $('#erm_eresepGab_inputan_obat_racik2').show();
          $("#erm_eresepGab_obat_racik_nmaobat").trigger('focus');
          $('#erm_eresepGabtable_obatracik tbody').html('');
  ...
  kd_produkObatRacik.onPilih(()=>{
    $("#erm_eresepGab_obat_racik_dosis").trigger('focus');
  });

  $("#erm_eresepGab_obat_racik_dosis").on("keyup", function(event){
    if (event.keyCode == 13) {
      $("#erm_eresepGab_obat_racik_qty").trigger('focus');
      $("#erm_eresepGab_obat_racik_qty").val("");
    }
  });

  $("#erm_eresepGab_obat_racik_qty").on("keyup", function(event){
    if (event.keyCode == 13) {
      $("#erm_eresepGab_obat_racik_ket").trigger('focus');
    }
  });

  $("#erm_eresepGab_obat_racik_ket").on("keyup", function(event){
    if (event.keyCode == 13) {
      var kd_obat  = kd_produkObatRacik.getValue();
      var nm_obat = document.getElementById("erm_eresepGab_obat_racik_nmaobat").value;
      var cekdosis = document.getElementById("erm_eresepGab_obat_racik_dosis").value;
      if (cekdosis != ''){
        var dosis = cekdosis;
      }else{
        var dosis = '0';
      }    
      var cekqty  = document.getElementById("erm_eresepGab_obat_racik_qty").value;
      if (cekqty != ''){
        var qty = cekqty;
      }else{
        var qty = '0';
      }
      var ket     = document.getElementById("erm_eresepGab_obat_racik_ket").value;
  ...
  $("#erm_eresepGab_btn_check_obatracik").click(function( event ) {
    var kd_obat  = kd_produkObatRacik.getValue();
    var nm_obat = document.getElementById("erm_eresepGab_obat_racik_nmaobat").value;
    var cekdosis   = document.getElementById("erm_eresepGab_obat_racik_dosis").value;
    if (cekdosis != ''){
...
function kosongObatJadi(){ 
  document.getElementById("erm_eresepGab_obatjadi_nm").disabled = false;
  $("#erm_eresepGab_obatjadi_nm").trigger('focus');
  document.getElementById("erm_eresepGab_obatjadi_urut").value  = '';
  document.getElementById("erm_eresepGab_obatjadi_nm").value    = '';
  document.getElementById("erm_eresepGab_obatjadi_qty").value   = '';
  document.getElementById("erm_eresepGab_obatjadi_signa").value = '';
  document.getElementById("erm_eresepGab_obatjadi_ket").value   = '';
...
function kosongJenisRacikan(){
  ...
  //$("#erm_eresepGab_nmaracikan").trigger('focus');
  document.getElementById("erm_eresepGab_nmaracikan").value   = '';
  document.getElementById("erm_eresepGab_bnykracikan").value  = '';
  document.getElementById("erm_eresepGab_signaracikan").value = '';
  document.getElementById("erm_eresepGab_ketracikan").value   = '';
  enabledObatJenisRacik();
}

function kosongObatRacik(){
  kd_produkObatRacik.reset();
  document.getElementById("erm_eresepGab_obat_racik_urut").value        = '';
  document.getElementById("erm_eresepGab_obat_racik_nmaobat").value     = '';
  document.getElementById("erm_eresepGab_obat_racik_nmaobat").disabled  = false;
  document.getElementById("erm_eresepGab_obat_racik_dosis").value       = '';
  document.getElementById("erm_eresepGab_obat_racik_qty").value         = '';
  document.getElementById("erm_eresepGab_obat_racik_ket").value         = '';
  $("#erm_eresepGab_obat_racik_nmaobat").trigger('focus');
}

function disabledObatJenisRacik(){
  document.getElementById("erm_eresepGab_nmaracikan").disabled      = true;
  document.getElementById("erm_eresepGab_bnykracikan").disabled     = true;
  document.getElementById("erm_eresepGab_signaracikan").disabled    = true;
  document.getElementById("erm_eresepGab_ketracikan").disabled      = true;
}

function enabledObatJenisRacik(){
  document.getElementById("erm_eresepGab_nmaracikan").disabled      = false;
  document.getElementById("erm_eresepGab_bnykracikan").disabled     = false;
  document.getElementById("erm_eresepGab_signaracikan").disabled    = false;
  document.getElementById("erm_eresepGab_ketracikan").disabled      = false;
  //$("#erm_eresepGab_nmaracikan").trigger('focus');
}
...
function erm_eresepGab_mulaiawalRacikan(){
  $("#erm_eresepGab_nmaracikan").trigger('focus');
  kd_JenisRacikan.reset();
  kd_signaObatRacik.reset();
  kosongJenisRacikan();
  $('#erm_eresepGabtable_obatracik tbody').html('');
  $('#erm_eresepGab_inputan_obat_racik2').hide();
}

function tampilkan_isi_obatjdi(kd_obat, nm_obat, qty, id_signa, signa, ket){
  //$('#erm_eresepGabtable_obatjadi tbody').html('');
  var nomor = $('#erm_eresepGabtable_obatjadi tbody tr').length + 1;  
  var Baris = '';
      Baris += "<tr>";
      //Baris += '<td>'+nomor+'</td>';
      Baris += "<td class='pl-0'>";
  ...
  var jmlObat   = $('#erm_eresepGabtable_obatjadi tbody tr').length;
  let total     = 0;
  const data    = [];
  ...
  if (status_kd_obatk == false){
    $('#erm_eresepGabtable_obatjadi tbody').append(Baris);
    //PROSES PENJUMLAHAN HARGA OBAT
    // for(var i = 0, iLen = jmlObat ; i < iLen; i++){     
    ...
    var urut = document.getElementById("erm_eresepGab_obatjadi_urut").value;
    if (urut != ''){
      $('#erm_eresepGabtable_obatjadi tbody').append(Baris);
      var totalx = document.getElementById("erm_eresepGab_grandtotal").value;
      total = parseInt(totalx) + parseInt(qty);
      ...
      //document.getElementById("erm_eresepGabtable_obatjadi").deleteRow(urut);  
    }else{
...
function editbaris_obatjadi(btn, nomor){
  ...
  var kd_obat  = document.getElementById("erm_eresepGabtable_obatjadi").rows[nomor].cells[2].firstChild.value;
  var nm_obat = document.getElementById("erm_eresepGabtable_obatjadi").rows[nomor].cells[3].firstChild.value;
  var qty     = document.getElementById("erm_eresepGabtable_obatjadi").rows[nomor].cells[4].firstChild.value;
  var signa   = document.getElementById("erm_eresepGabtable_obatjadi").rows[nomor].cells[5].firstChild.value;
  var ket     = document.getElementById("erm_eresepGabtable_obatjadi").rows[nomor].cells[6].firstChild.value;
  ...
  document.getElementById("erm_eresepGab_obatjadi_urut").value  = nomor;
  document.getElementById("erm_eresepGab_obatjadi_nm").disabled = true;
  //document.getElementById("erm_eresepGab_obatjadi_nm").value    = nm_obat;
  document.getElementById("erm_eresepGab_obatjadi_qty").value   = qty;
  //document.getElementById("erm_eresepGab_obatjadi_signa").value = signa;
  document.getElementById("erm_eresepGab_obatjadi_ket").value   = ket;
}
...
function hapusbaris_obatjadi(btn, nomor){
  ...
  var no = 1;
  $('#erm_eresepGabtable_obatjadi tbody tr').each(function(){
...
function tampilkan_isi_obatracik(kd_obat, nm_obat, dosis, qty, ket){
  var nomor = $('#erm_eresepGabtable_obatracik tbody tr').length + 1;  
  var Baris = '';
      Baris += '<tr>';
      Baris += "<td class='pl-0'>";
      ...
      Baris += "</td>";
      Baris += "<td style='display: flex;'><button type='button' class='btn btn-xs btn-danger' onclick='hapusbaris_obatracik(this, "+nomor+")' id='hapusbaris_obatracik" + nomor + "' style='width:100%' ><i class='fa fa-times'></i></button><button type='button' class='btn btn-xs btn-outline-warning' onclick='editbaris_obatracik(this, "+nomor+")' id='editbaris_obatracik" + nomor + "' style='width:100%'><i class='fa fa-edit'></i></button></td>";
      Baris += "<td>";
  ...
  var jmlObat   = $('#erm_eresepGabtable_obatracik tbody tr').length;
  let total     = 0;
  const data    = [];  
  for(var i = 0, iLen = jmlObat ; i < iLen; i++){
    //PROSES ARRAY PENGECEKAN KODE OBAT
  ...
  if (status_kd_obatk == false){
    $('#erm_eresepGabtable_obatracik tbody').append(Baris);
    
    sessionStorage_Racikan();
  }else{
    var urut = document.getElementById("erm_eresepGab_obat_racik_urut").value;
    if (urut != ''){
      $('#erm_eresepGabtable_obatracik tbody').append(Baris);
      
      var hapusrow = document.getElementById("hapusbaris_obatracik"+urut); 
      hapusrow.click();
...
function editbaris_obatracik(btn, nomor){
  
  var kd_obat  = document.getElementById("erm_eresepGabtable_obatracik").rows[nomor].cells[2].firstChild.value;
  var nm_obat  = document.getElementById("erm_eresepGabtable_obatracik").rows[nomor].cells[3].firstChild.value;
  var dosis    = document.getElementById("erm_eresepGabtable_obatracik").rows[nomor].cells[4].firstChild.value;
  var qty      = document.getElementById("erm_eresepGabtable_obatracik").rows[nomor].cells[5].firstChild.value;
  var ket      = document.getElementById("erm_eresepGabtable_obatracik").rows[nomor].cells[6].firstChild.value;
  
  $("#erm_eresepGab_obat_racik_qty").trigger('focus');

  kd_produkObatRacik.setValue(nm_obat);
  
  document.getElementById("erm_eresepGab_obat_racik_urut").value        = nomor;
  document.getElementById("erm_eresepGab_obat_racik_nmaobat").disabled  = true;
  document.getElementById("erm_eresepGab_obat_racik_dosis").value       = dosis;
  document.getElementById("erm_eresepGab_obat_racik_qty").value         = qty;
  document.getElementById("erm_eresepGab_obat_racik_ket").value         = ket;
}
...
function sessionStorage_Racikan(){
  ...
  var count     = $('#erm_eresepGabtable_obatracik tbody tr').length;
...
function hapusbaris_obatracik(btn, nomor){
  ...
  sessionStorage_Racikan();
  var no = 1;
  $('#erm_eresepGabtable_obatracik tbody tr').each(function(){
    ...
    $(this).find('td:nth-child(2)').html("<button type='button' class='btn btn-xs btn-danger' onclick='hapusbaris_obatracik(this, "+no+")' id='hapusbaris_obatracik" + no + "' style='width:100%'><i class='fa fa-times'></i></button><button type='button' class='btn btn-xs btn-outline-warning' onclick='editbaris_obatracik(this, "+no+")' id='editbaris_obatracik" + no + "' style='width:100%'><i class='fa fa-edit'></i></button>");
    no++;
  });
}
...
function tampilkan_isi_obatracik_jenisracikan(nma_racikan, byk_racikan, id_sig_rac, sig_racikan, ket_racikan){  
  ...
  */
  ...
  $('#erm_eresepGabtable_obatracik_jenisracikan tbody').append(Baris);
  $('#erm_eresepGab_infojenis_racikan').html('<i class="fa fa-check"></i> '+nama_racikan);
...
function tampilkan_jenisracik(Nomor, nma_racikan, byk_racikan, sig_racikan, ket_racikan, x){
  nama_racikan = x;
  document.getElementById("erm_eresepGab_nmaracikan").value   = nma_racikan;
  document.getElementById("erm_eresepGab_bnykracikan").value  = byk_racikan;
  document.getElementById("erm_eresepGab_signaracikan").value = sig_racikan;
  document.getElementById("erm_eresepGab_ketracikan").value   = ket_racikan;
...
function hapus_jenisracik(btn, Nomor, nma_racikan, byk_racikan, sig_racikan, ket_racikan, nama_racikan){
  ...
  var no = 1;
  $('#erm_eresepGabtable_obatracik_jenisracikan tbody tr').each(function(){
    $(this).find('td:nth-child(1)').html(no);
    no++;
  });
...
function tabrwj_resep_obatjadi(){
  $('#erm_eresepGab_inputan_obat_jadi').show();
  $('#erm_eresepGab_inputan_obat_racik').hide();
  $('#erm_eresepGab_inputan_obat_racik1').hide(); 
  $('#erm_eresepGab_inputan_obat_racik2').hide(); 
  $('#erm_eresepGab_penentu_resepobat').val(0);
  $("#erm_eresepGab_obatjadi_nm").trigger('focus');
  $('#erm_eresepGab_infojenis_racikan').html('-');
}

function tabrwj_resep_obatracik(){
  $('#erm_eresepGab_inputan_obat_jadi').hide();
  $('#erm_eresepGab_inputan_obat_racik').show(); 
  $('#erm_eresepGab_inputan_obat_racik1').show(); 
  $('#erm_eresepGab_inputan_obat_racik2').hide(); 
  $('#erm_eresepGab_penentu_resepobat').val(1);  
  kosongObatJenisRacik();
  //$("#erm_eresepGab_nmaracikan").trigger('focus');
}

function keluarmodal_erm_eresepGab() {
  $('#modal_erm_eresepGab').modal('hide');
  $('.modal-backdrop').hide();
  sessionStorage.clear();
}

function erm_eresepGab_kembalikeawal(){
  var idresep = document.getElementById("erm_eresepGab_idresep").value;
  if (idresep == ''){    
    pertanyaan.fire({
...
function erm_eresepGab_hpus_order(){
  var idresep = document.getElementById("erm_eresepGab_idresep").value;
  if (idresep != ''){    
    pertanyaan.fire({
      ...
      if (result.isConfirmed) {
        ...
        apiPOST('Apotek/HapusOrderEresepRJ', param, hasil => {
          if (hasil !== null) {
            sessionStorage.clear();
            var penentu = $('#erm_eresepGab_penentu_resepobat').val(1);  
            ...
            $('#erm_eresepGabtable_obatracik_jenisracikan tbody').html('');
            $('#erm_eresepGabtable_obatracik tbody').html('');
            document.getElementById("erm_eresepGab_idresep").value  = '';
            document.getElementById("erm_eresepGab_diagnosa").value = '';
            document.getElementById("erm_eresepGab_iter").value     = '';
            document.getElementById("erm_eresepGab_grandtotal").value = '0';
            document.getElementById("verm_eresepGab_grandtotal").innerHTML = '0';
...
function params_SimpanObatJadi(){  
  var getkd_obat = document.getElementsByName('ermIrja_obtjadikd_obat[]');
  ...
  var count     = $('#erm_eresepGabtable_obatjadi tbody tr').length;
...
function params_SimpanObatRacik(){
  ...
  var count       = $('#erm_eresepGabtable_obatracik_jenisracikan tbody tr').length;
...
function erm_eresepGab_simpanorder(){
  $('#loading_modal_erm_eresepGab').show();
  var jnsresep = document.getElementById('erm_eresepGab_jenisresep').value;
  if (jnsresep == '0'){
    if ((id_unit == '3001')||(id_unit == '3002')){
      
    }else{
      toastr.warning("Jenis Resep Belum ditentukan!!");
      $('#erm_eresepGab_jenisresep').trigger('focus');
      //$('#loading_modal_erm_eresepGab').hide();
      // return;
    }
  }

  var id_dokter = document.getElementById('erm_eresepGab_dokter').value;
  if ((id_dokter == '')||(id_dokter == '0')||(id_dokter == '11')){
    toastr.warning("Dokter Belum dipilih!!");
    $('#erm_eresepGab_dokter').trigger('focus');
    $('#loading_modal_erm_eresepGab').hide();
    return;
  }
  ...
  var param = {
    id_kunj       : id_kunjungan,
    id_unit       : id_unit,
    id_peg        : id_dokter, //user['id_pegawai'],
    ...
    user          : user['id_user'],
    data          : params_SimpanObatJadi(),
    jmlObat       : $('#erm_eresepGabtable_obatjadi tbody tr').length,
    data_racik    : params_SimpanObatRacik(),
    jmlObatRacik  : $('#erm_eresepGabtable_obatracik_jenisracikan tbody tr').length,
    tglorder      : document.getElementById('erm_eresepGab_tglresep').value,
    jnsresep      : jnsresep
  };
  ...
  apiPOST('Apotek/CreateOrderResepRWJ', param, hasil => {
    if (hasil !== null) {
      document.getElementById("erm_eresepGab_idresep").value = hasil['x'];
      $('#loading_modal_erm_eresepGab').hide();
    }else{
      //$('#loading_modal_erm_eresepGab').hide();
    }
...
function preview_detailObat(){  
  ...
  var json_data = {
    ...
    'tgl_ordprevRWJ' : document.getElementById('erm_eresepGab_tglresep').value,
    ...
    'idresepRWJ'     : document.getElementById("erm_eresepGab_idresep").value,
    'jnsresep'       : textjnsresep.replace(/ /g, '%20'),
    'idjnsresep'     : jnsresep,
  };

  var myJSON = JSON.stringify(json_data);
  $('.'+rekammedis_prev).load('Apotek/preview_detailObat?data='+ myJSON);
  
}

function erm_eresepGab_history(){  
  ...
  var myJSON = JSON.stringify(json_data);
  $('.'+rekammedis_prev).load('Apotek/historyorder_eresep?data='+ myJSON);
  
}

function erm_eresepGab_templateresep(){  
  ...
  var myJSON = JSON.stringify(json_data);
  $('.'+rekammedis_prev).load('Apotek/template_eresep?data='+ myJSON);
  
}

/*
function erm_autocomplete_obat(){
    getObat_erm_eresepGab2();
    $(".erm_eresepGab_pencarian").select2({      
