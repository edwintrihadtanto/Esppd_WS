...
?>
<div class="content modal fade" id="mod_bukatransaksi" style="margin-left: 180px;">
                      ...
                      <div class="col-md-6 col-sm-6 col-6 p-1">
                        <div class="info-box mb-0">
                          <table class="table table-striped table-sm" id="pembayaranvalue" cellspacing="0" cellpadding="0" border="0">
                            <tbody>
                              <tr>
                                <td width="70">Alasan Buka Transaksi</td>
                                <td>:</td>
                                <td>
                                  <input type="text" class="form-control form-control-xs" id="alasanbukatransaksi" name="alasanbukatransaksi">
                                </td>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td>
                                  <button type="button" class="btn bg-gradient-info btn-xs BtnbukaTransaksi float-right"><i class="fa fa-close"></i> Buka Transaksi</button>
                                </td>
                              </tr>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    var MyTablekasirbukatransaksi = $('#tablehistory_lokup_produk').dataTable({
      "paging": true,
      "lengthChange": true,
      "searching": true,
      "ordering": true,
    ...
    function kasirgeneralrefresh() {
      MyTablekasirbukatransaksi = $('#tablehistory_lokup_produk').dataTable();
    }
  ...
  $("#mod_bukatransaksi").modal({
    backdrop: "static"
  });
  $('#mod_bukatransaksi').on('shown.bs.modal', function() {

  })
  $(".BtnbukaTransaksi").click(function() {
    //tambahbayar();
    var id_transaksi = <?php echo $row['id_transaksi'] ?>;
    var user = JSON.parse(localStorage['data_user']);
    var id_user = user['id_user'];
    var alasan = $("#alasanbukatransaksi").val();
    pertanyaan.fire({
      title: 'Proses Pembukaan Transaksi',
      html: '<span>Transaksi Nomor ' + id_transaksi + ', Apakah Yakin di Buka ?</span>',
      icon: 'question',
      ...
      if (result.isConfirmed) {
        ...
        apiPOST('Kasirgeneral/Buka_transaksi', param, hasil => {
