            ...
            <div class="row row-custom">
                <div class="col-sm-auto">
                    <div class="form-group">
                        <label for="pengirimanLogistik_nofaktur">Unit Permintaan</label>
                        <input type="search" class="form-control form-control-xs" placeholder="Entry No. Faktur" id="pengirimanLogistik_nofaktur" name="pengirimanLogistik_nofaktur" onkeypress="tampilpengirimanLogistik()">
                    </div>
                </div>
                <div class="col-sm-auto">
                    <div class="form-group">
                        <label for="pengirimanLogistik_tglpengiriman">Tgl. Permintaan :</label>
                        <input type="date" class="form-control form-control-xs" id="pengirimanLogistik_tglpengiriman" name="pengirimanLogistik_tglpengiriman" onchange="tampilpengirimanLogistik()">
                    </div>
                </div>
                <div class="col-sm-auto">
                    <div class="form-group">
...
<script>
    ...
    document.getElementById('pengirimanLogistik_tglpengiriman').value = nowday;
    ...
    function tampilpengirimanLogistik() {
        ...
        var param = {
            tglpermintaan: document.getElementById('pengirimanLogistik_tglpengiriman').value,
