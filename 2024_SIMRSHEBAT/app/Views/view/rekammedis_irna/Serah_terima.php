...
<div class="col-md-12">
	<div class="overlay-wrapper" id="inputserahterima_loadingawal">
		<div class="overlay">
	...
	<div id="divserahterima" >		
		<div class="card "><!-- S (Situation) -->
			<div class="card-header" style="background-color:black;">								
				<h3 class="card-title" style="color:white;">Serah Terima Pasien</h3>
						...
						<div class="form-group row">
							...
							<div class="col-md-3">
								<div class="input-group date" id="dactranspasien_datgl" data-target-input="nearest">
									<input id="dactranspasien_atgl" name="atgl" type="date" value="<?php echo date('Y-m-d')?>" class="form-control">
								</div>
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group row">
							...
							<div class="col-md-9" id="dactranspasien_dcederahasilId">
								...
								<div class="custom-control custom-checkbox custom-control-inline">
									<input name="dactranspasien_dcederahasilId" value="2" type="radio" class="custom-control-input" id="dactranspasien_dcederahasilId_2" checked>
					...
					<div class="col-md-6">
						...
						<div class="form-group row">
							...
							<div class="col-md-6" id="dactranspasien_plab">
								<div class="custom-control custom-checkbox custom-control-inline">
									<input onclick="document.getElementById('dactranspasien_div_plab').style.display='none'" name="dactranspasien_plab" value="Tidak" type="radio" class="custom-control-input" id="dactranspasien_plab_1" checked>
									<label class="custom-control-label" for="dactranspasien_plab_1">Tidak</label>
								</div>
								<div class="custom-control custom-checkbox custom-control-inline">
									<input onclick="document.getElementById('dactranspasien_div_plab').style.display='block'" name="dactranspasien_plab" value="Ya" type="radio" class="custom-control-input" id="dactranspasien_plab_2">
						...
						<div class="form-group row">
							...
							<div class="col-md-6" id="dactranspasien_prad">
								<div class="custom-control custom-checkbox custom-control-inline">
									<input onclick="document.getElementById('dactranspasien_div_prad').style.display='none'" name="dactranspasien_prad" value="Tidak" type="radio" class="custom-control-input" id="dactranspasien_prad_1" checked>
									<label class="custom-control-label" for="dactranspasien_prad_1">Tidak</label>
								</div>
								<div class="custom-control custom-checkbox custom-control-inline">
									<input onclick="document.getElementById('dactranspasien_div_prad').style.display='block'" name="dactranspasien_prad" value="Ya" type="radio" class="custom-control-input" id="dactranspasien_prad_2">
						...
						<div class="form-group row">
							...
							<div class="col-md-6" id="dactranspasien_pekg">
								<div class="custom-control custom-checkbox custom-control-inline">
									<input onclick="document.getElementById('dactranspasien_div_pekg').style.display='none'" name="dactranspasien_pekg" value="Tidak" type="radio" class="custom-control-input" id="dactranspasien_pekg_1" checked>
									<label class="custom-control-label" for="dactranspasien_pekg_1">Tidak</label>
								</div>
								<div class="custom-control custom-checkbox custom-control-inline">
									<input onclick="document.getElementById('dactranspasien_div_pekg').style.display='block'" name="dactranspasien_pekg" value="Ya" type="radio" class="custom-control-input" id="dactranspasien_pekg_2">
						...
						<div class="form-group row">
							...
							<div class="col-md-6" id="dactranspasien_plain">
								<div class="custom-control custom-checkbox custom-control-inline">
									<input onclick="document.getElementById('dactranspasien_div_plain').style.display='none'" name="dactranspasien_plain" value="Tidak" type="radio" class="custom-control-input" id="dactranspasien_plain_1" checked>
									<label class="custom-control-label" for="dactranspasien_plain_1">Tidak</label>
								</div>
								<div class="custom-control custom-checkbox custom-control-inline">
									<input onclick="document.getElementById('dactranspasien_div_plain').style.display='block'" name="dactranspasien_plain" value="Ya" type="radio" class="custom-control-input" id="dactranspasien_plain_2">
					...
					<div class="col-md-6">
						...
						<div class="form-group row">
							...
							<div class="row col-md-6" id="dactranspasien_dadvis">
								<div class="custom-control custom-checkbox custom-control-inline">
									<input onclick="document.getElementById('dactranspasien_div_dadvis2').style.display='block'" name="dactranspasien_dadvis" value="Tidak" type="radio" class="custom-control-input" id="dactranspasien_dadvis_1">
									<label class="custom-control-label" for="dactranspasien_dadvis_1">Sudah Ada</label>
								</div>
								<div class="custom-control custom-checkbox custom-control-inline">
									<input onclick="document.getElementById('dactranspasien_div_dadvis2').style.display='none'" name="dactranspasien_dadvis" value="Ya" type="radio" class="custom-control-input" id="dactranspasien_dadvis_2" checked>
	...
	<script type="text/javascript">
		...
		function listpasienserahterima(){  
			var listParam = [
...
/*			document.getElementById('namaermirna').value    	=nama;
		...
		function tampil_spesial(){
			document.getElementById('rwiserahterimatr_ruang').innerHTML = '';
			document.getElementById('serahterimaid_kamar').innerHTML = '';
			apiPOST('Setup/getSpesialisasi', null, hasil => {
				var ruang = "<option value=''> - Silahkan Pilih -</option>";
				var a = hasil['data'];
				for (var i = 0; i < a.length; i++) {
					ruang += '<option value="' + a[i]['kd_spesial'] + '">' + a[i]['spesialisasi'] + '</option>';
				}
		...
		function tampil_serahterimarwiunit() {
			...
			apiPOST('Setup/unitsps', param, hasil => {
		...
		function tampil_rwiserahterimaruang() {
			...
			apiPOST('Setup/ruangsps', param, hasil => {
				var ruang = "<option value=''> *Pilih </option>";
				var a = hasil['data'];
				for (var i = 0; i < a.length; i++) {
					ruang += '<option value="' + a[i]['no_kamar'] + '">' + a[i]['nama_kamar'] + '</option>';
				}
  ...
  // document.getElementById('rwipendftr_ruang').innerHTML = ruang;
		...
		function tampil_rawat_awal(param){
			apiPOST('Rekammedisirna/searchPerawat', param, hasil => {
				...
				var a = hasil['data'];
				for (var i = 0; i < a.length; i++) {
					sus += '<option value="' + a[i]['kd_perawat'] + '">' + a[i]['nama_perawat'] + '</option>';
				}
		...
		function tampil_dok_awal(param){
			apiPOST('Rekammedisirna/searchDokter', param, hasil => {
				...
				var a = hasil['data'];
				for (var i = 0; i < a.length; i++) {
					dok += '<option value="' + a[i]['kd_dokter'] + '">' + a[i]['nama'] + '</option>';
				}
		...
		function showSerahTerima(){
			document.getElementById("inputserahterima_loadingawal").style.display = 'block';
			...
			apiPOST('Rekammedisirna/showserahterima', param,hasil=>{
				document.getElementById("inputserahterima_loadingawal").style.display = 'none';
