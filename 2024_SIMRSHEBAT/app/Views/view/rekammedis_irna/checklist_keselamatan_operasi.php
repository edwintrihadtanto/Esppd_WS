<div class="col-md-12 p-2">
	<div class="overlay-wrapper" id="checklistkeselamatanop_loadingawal">
		<div class="overlay">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<div class="input-group date" id="dacricheckok_datgl" data-target-input="nearest">
									<input id="dacricheckok_atgl" value="<?php echo date('Y-m-d');?>" name="atgl" type="date" class="form-control">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-4">
						...
						<div class="form-group row">
							<div class="col-md-0"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
							<div class="col-md-11">
								<div class="row" id="divdacricheckok_ckelengkapanId">
									<div class="col-md-8">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
										...
										<div class="row mb-1" id="dacricheckok_div_cmembacalist1" style="">
											<div class="col-md-6">
												<div class="input-group date" id="dacricheckok_dcmembacalistket1" >
													<input id="dacricheckok_cmembacalistket1" name="cmembacalistket1" type="date" class="form-control" value="<?php echo date('Y-m-d');?>">
												</div>
											</div>
										</div>
									</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-12">
							...
							<div class="form-group row">
								<div class="col-md-0"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
								<div class="col-md-11">
									<div class="row" id="divdacricheckok_dpenangananId">
										<div class="col-md-4">
											<div class="form-group">
												<div class="row custom-control custom-checkbox custom-control-inline">
							...
							<div class="form-group row">
								<div class="col-md-0"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
								<div class="col-md-11">
									<div class="row" id="divdacricheckok_dimplantId">
										<div class="col-md-4">
											<div class="form-group">
												<div class="row custom-control custom-checkbox custom-control-inline">
							...
							<div class="form-group row">
								<div class="col-md-0"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
								<div class="col-md-11">
									<div class="row" id="divdacricheckok_dreviewId">
										<div class="col-md-4">
											<div class="form-group">
												<div class="row custom-control custom-checkbox custom-control-inline">
...
<!-- <div class="viewListPasienCheckliskeselamatanop"></div> -->
<script>
	...
	$(document).ready(function() {
		...
		if (data=='') {
			var url  = '';
			var view = 'viewchecklistkeselamatanop';
	...
	function saveCheckoperasi(){
		...
		var param={
			...
			tanggal_op:$('#dacricheckok_cmembacalist_1').val(),
			...
			lokasi2:$('#dacricheckok_cmembacalistket5').val(),
			...
			tgl_op :$('#dacricheckok_cmembacalistket1').val()
		};

		apiPOST("Rekammedisirna/saveCheckoperasi", param, hasil => {
		});
	}
	function showCheckliskeselamatanop(){
		document.getElementById("checklistkeselamatanop_loadingawal").style.display = 'block';
		var param = {
			id_transaksi   	: $('#transaksiermirna').val(),
			id_kunjungan 	: $('#idKunjunganermirna').val(),
			iduser          : user.id_user
		...
		apiPOST('Rekammedisirna/showchecklistkeselamatanop', param,hasil=>{
			document.getElementById("checklistkeselamatanop_loadingawal").style.display = 'none';
			if (hasil['data'].length == 0){
				toastr.error("Belum Ada Checklist Keselamatan Operasi!");
			}else{
				toastr.info("Data Checklist Keselamatan Operasi di Temukan");
			}
		});
	}
</script>