<div class="col-md-12 p-2">
	<div class="card card-outline card-danger">
		<div class="overlay-wrapper" id="preoperasi_loadingawal">
			<div class="overlay">
				<i class="fas fa-3x fa-sync-alt fa-spin"></i>
			</div>
		</div>  
		<div class="card-body p-2 darkgrey-custom" id='DivsearchPreoperasi'>
			<div class="row">
				<div class="col-sm-4">
	...
	<div class="col-12 p-1" id="Divcardlistpasermirna_operasi">
		<div class="card">
			<div class="card-header p-0">
				<div class="col-md-12 p-0" id="ermirna_listpas_operasi">
					<div class="card-body p-1" style="max-height: 420px; overflow: auto;">
						<div class="row" id="listpasermirna_operasi"></div>
					</div>
				</div>
			</div>
		</div>
	</div>
	<div class="card-body p-2 darkgrey-custom" id="DivPreoperasi" style="display: none;">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-md-3">
								<input id="dacperioperatifpra_id" name="id" type="text" class="form-control" readonly="readonly">
							</div>
							<div class="col-md-6">
						...
						<div class="form-group row">
							...
							<div class="col-md-4">
								<div class="input-group date" id="dacperioperatifpra_datgl" data-target-input="nearest">
								  <input id="dacperioperatifpra_atgl" name="atgl" type="date" class="form-control">				              
								</div>
							</div>
						</div>
						<div class="form-group row">
				...
				<div class="row ">
					...
					<div class="col-md-4">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<div class="input-group">
									<input type="number" onfocus="this.select();" class="form-control" id="dacperioperatifpra_jbb" onkeyup="dacperioperatifpraex.onChangeIMT();">
									<span class="input-group-append">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<div class="input-group">
									<input type="number" onfocus="this.select();" class="form-control" id="dacperioperatifpra_jtb" onkeyup="dacperioperatifpraex.onChangeIMT();">
									<span class="input-group-append">
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<input type="number" onfocus="this.select();" class="form-control" id="dacperioperatifpra_kimt">
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-3">
							...
							<div class="col-md-6">
								<div class="row" id="dacperioperatifpra_bemosi">
									<div class="col-md-6">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
												<input onclick="document.getElementById('dacperioperatifpra_div_bemosi_4').style.display='none'" name="dacperioperatifpra_bemosi" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_bemosi_1">
							...
							<div class="col-md-6">
								<div class="row" id="dacperioperatifpra_bvisitdrop">
									<div class="col-md-6">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
												<input name="dacperioperatifpra_bvisitdrop" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_bvisitdrop_1">
							...
							<div class="col-md-6">
								<div class="row" id="dacperioperatifpra_bvisitdrop">
									<div class="col-md-6">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
												<input name="dacperioperatifpra_bvisitdran" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_bvisitdran_1">
							...
							<div class="col-md-6">
								<div class="row" id="dacperioperatifpra_bhamil">
									<div class="col-md-6">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
												<input onclick="document.getElementById('dacperioperatifpra_div_bhamil_2').style.display='none'" name="dacperioperatifpra_bhamil" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_bhamil_1">
							...
							<div class="col-md-6">
								<div class="row" id="dacperioperatifpra_bhaid">
									<div class="col-md-6">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
												<input onclick="document.getElementById('dacperioperatifpra_div_bhaid_2').style.display='none'" name="dacperioperatifpra_bhaid" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_bhaid_1">
							...
							<div class="col-md-6">
								<div class="row" id="dacperioperatifpra_bpremedikasi">
									<div class="col-md-6">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
												<input onclick="document.getElementById('dacperioperatifpra_div_bpremedikasi_2').style.display='none'" name="dacperioperatifpra_bpremedikasi" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_bpremedikasi_1">
										...
										<div class="form-group">
											...
											<div id="dacperioperatifpra_div_bpremedikasipilihlist_1" class="row" style="display: none;">
												...
												<div class="col-md-5  text-truncate">
													<input type="text" onfocus="this.select();" class="form-control" id="dacperioperatifpra_bpremedikasipilihlistket1">
												</div>
												<div class="col-md-3  text-truncate">
													<div class="input-group">
														<span class="input-group-prepend">
														...
														<input type="text" onfocus="this.select();" class="form-control" id="dacperioperatifpra_bdosis1">
													</div>
												</div>
												<div class="col-md-3">
													<div class="input-group date" id="dacperioperatifpra_dajam">
														<input id="dacperioperatifpra_bdosisijam1" name="bdosisijam1" type="time" class="form-control datetimepicker-input">
													</div>
												</div>												
											</div>
										</div>
											...
											<div id="dacperioperatifpra_div_bpremedikasipilihlist_2" class="row" style="display: none;">
												...
												<div class="col-md-3  text-truncate">
													<div class="input-group">
														...
														<input type="text" onfocus="this.select();" class="form-control" id="dacperioperatifpra_bdosis2">
													</div>
												</div>
												<div class="col-md-4">
													<div class="input-group date" id="dacperioperatifpra_dajam2" data-target-input="nearest">
														  ...
														  <input id="dacperioperatifpra_bdosisijam2" name="bdosisijam2" type="time" class="form-control datetimepicker-input">
													</div>
												</div>												
												<div class="col-md-1  text-truncate">
													<span class="input-group-prepend">
												...
												<div class="col-md-3  text-truncate mt-2">
													<div class="input-group">
														...
														<input type="text" onfocus="this.select();" class="form-control" id="dacperioperatifpra_bdosis3">
													</div>
												</div>
												<div class="col-md-4 mt-2">
													<div class="input-group date" id="dacperioperatifpra_dajam33" data-target-input="nearest">
														  ...
														  <input id="dacperioperatifpra_bdosisijam3" name="bdosisijam3" type="time" class="form-control datetimepicker-input">
													</div>
												</div>												
												<div class="col-md-1  text-truncate ">
													<span class="input-group-prepend">
												...
												<div class="col-md-4  text-truncate mt-2">
													<input type="text" onfocus="this.select();" class="form-control" id="dacperioperatifpra_bpremedikasipilihlistket4">
												</div>
												<div class="col-md-3  text-truncate mt-2">
													<div class="input-group">
														<span class="input-group-prepend">
														...
														<input type="text" onfocus="this.select();" class="form-control" id="dacperioperatifpra_bdosis4">
													</div>
												</div>
												<div class="col-md-4 mt-2">
													<div class="input-group date" id="dacperioperatifpra_dajam44" data-target-input="nearest">
														  ...
														  <input id="dacperioperatifpra_bdosisijam4" name="bdosisijam4" type="time" class="form-control datetimepicker-input">
													</div>
												</div>												
											</div>					            			
										</div>
							...
							<div class="col-md-6">
								<div class="row" id="dacperioperatifpra_bskriningmrsa">
									<div class="col-md-6">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
												<input onclick="document.getElementById('dacperioperatifpra_div_bskriningmrsa_2').style.display='none'" name="dacperioperatifpra_bskriningmrsa" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_bskriningmrsa_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek1">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek1" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek1_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek1">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek1" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek1_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek2">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek2" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek2_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek2">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek2" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek2_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek3">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek3" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek3_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek3">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek3" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek3_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek4">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek4" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek4_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek4">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek4" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek4_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek5">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek5" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek5_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek5">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek5" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek5_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek6">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek6" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek6_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek6">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek6" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek6_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek7">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek7" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek7_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek7">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek7" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek7_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek8">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek8" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek8_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek8">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek8" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek8_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek9">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek9" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek9_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek9">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek9" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek9_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek11">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek11" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek11_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek11">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek11" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek11_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek12">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek12" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek12_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek12">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek12" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek12_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek13">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek13" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek13_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek13">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek13" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek13_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek14">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek14" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek14_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek14">
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek14" value="1" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek14_1">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek15">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek15" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek15_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek15">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek15" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek15_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cruangcek16">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cruangcek16" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cruangcek16_2">
											...
											<div class="col-md-9  text-truncate">
												<div class="row" id="dacperioperatifpra_cokcek16">
													...
													<div class="col-md-6">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
																<input name="dacperioperatifpra_cokcek16" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_cokcek16_2">
									...
									<tr>
										<td style="padding:3px;">
											...
											<div class="row" style="padding:3px;margin-inline-start: 15px">
												<div class="col-md-12  text-truncate">
													<div class="row" id="dacperioperatifpra_asuhan1">
														<div class="col-md-12">
															<div class="form-group">
																<div class="row custom-control custom-radio custom-control-inline">
														...
														<div class="col-md-12">
															<div class="form-group">
																<div class="row custom-control custom-radio custom-control-inline">
																	...
																	<label class="custom-control-label" for="dacperioperatifpra_asuhan15_1">Anjurkan menghiiangkan bahaya lingkungan</label>
																</div>
															</div>
														</div>
													</div>
				...
				<div class="row ">
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-md-3">
								<input id="dacperioperatifpra_id2" name="id2" type="text" class="form-control" readonly="readonly" value="10">
							</div>
							<div class="col-md-6">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_tempatok">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
				...
				<div class="row ">
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_sadar">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_emosi">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_tindakan">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
									...
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
												<input name="dacperioperatifpra_tindakan" value="2" type="radio" class="custom-control-input" id="dacperioperatifpra_tindakan_2">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_tipeop">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_bius">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
									...
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
												...
												<label class="custom-control-label" for="dacperioperatifpra_bius_2">Spiral/ Epidural</label>
											</div>
										</div>
									</div>
									<div class="col-md-4">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_jenisop">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_canul">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_posisiop">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_lengan">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_urincat">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row" id="dacperioperatifpra_div_urincat_2" style="display:none;">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_urinpasang">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-radio custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_insisijml">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_insisijns">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_diatermiyesno">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row" id="dacperioperatifpra_div_diatermiyesno_2" style="display:none;">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_diatermi">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_netral">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
					...
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_touryesno">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row" id="dacperioperatifpra_div_touryesno_2" style="display:none;">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_tour">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_implant">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_drain">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_irigasiyesno">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row" id="dacperioperatifpra_div_irigasiyesno_2" style="display:none;">
							<div class="col-md-3"> </div>
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_irigasi">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-radio custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_tampon">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<div class="row" id="dacperioperatifpra_antibiotik">
									<div class="col-md-4">
										<div class="form-group">
											<div class="row custom-control custom-checkbox custom-control-inline">
		...
		<div class="card"><!-- TTD Perawat Asisten -->		
			<div class="card-body">
				<div class="row">
					<div class="col-md-3">
						...
						<div class="form-group row d-none" id="dacperioperatifpra_divqrcode6">
							<div class="col-md-12" align="center">
								<img id="dacperioperatifpra_qrcode6">
							</div>
						</div>								
								...
								<tbody>
								  <tr>
									<td width="30%" style="padding:0;">
										 <div id="dacperioperatifpra_ttdid6" class="sigPad border border-dark" style="width:250px;">										  
										  <div class="sig sigWrapper border border-dark current" style="height: auto; display: block;">
											<canvas id="dacperioperatifpra_ttd6" class="pad" width="240" height="120"></canvas>
											<input id="dacperioperatifpra_codesig6" type="hidden" name="output-3" class="output" value="">
										  </div>
										</div>
									</td>
								  </tr>
						...
						<div class="col-md-12" align="center">
							<div class="col-md-10">
								<select id="dacperioperatifpra_apj6Id" class="form-control"></select>
							</div>
						</div>
						<div class="form-group row">
							 <div class="col-md-12" align="center">
						...
						<div class="form-group row">
							 <div align="center" class="col-md-12">
									<button id="dacperioperatifpra_btttd6" type="button" class="btn btn-sm btn-danger d-none"><!-- <i class="fas fa-signature"></i> --> Validasi</button>
							 </div>
						</div>
					</div>	
					<div class="col-md-3">
						<div class="form-group row">
							<div class="col-md-12" align="center">
								<label class="col-form-label">Perawat Instrumen</label>
							</div>
						</div>
						<div class="form-group row d-none" id="dacperioperatifpra_divqrcode7">
							<div class="col-md-12" align="center">
								<img id="dacperioperatifpra_qrcode7">
							</div>
						</div>							
						<div class="table-responsive" align="center">
							<table class="table table-condensed d-none" style="width:250px; height: 120px;">
								<tbody><tr>
									<td width="30%" style="padding:0;">
										 <div id="dacperioperatifpra_ttdid7" class="sigPad border border-dark" style="width:250px;">										  
											  <div class="sig sigWrapper border border-dark current" style="height: auto; display: block;">
												<canvas id="dacperioperatifpra_ttd7" class="pad" width="240" height="120"></canvas>
												<input id="dacperioperatifpra_codesig7" type="hidden" name="output-3" class="output" value="">
											  </div>
										</div>
									</td>
								  </tr>
						...
						<div class="col-md-12" align="center">
							<div class="col-md-10">
								<select id="dacperioperatifpra_apj7Id" class="form-control"></select>
							</div>
						</div>
						<div class="form-group row">
							 <div class="col-md-12" align="center">
						...
						<div class="form-group row">
							 <div align="center" class="col-md-12">
									<button id="dacperioperatifpra_btttd7" type="button" class="btn btn-sm btn-danger d-none"><!-- <i class="fas fa-signature"></i> --> Validasi</button>
							 </div>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group row">
							<div class="col-md-12" align="center">
								<label class="col-form-label">Perawat Sirkuler</label>
							</div>
						</div>
						<div class="form-group row d-none" id="dacperioperatifpra_divqrcode8">
							<div class="col-md-12" align="center">
								<img id="dacperioperatifpra_qrcode8">
							</div>
						</div>								
						<div class="table-responsive" align="center">
							<table class="table table-condensed d-none" style="width:250px; height: 120px;">
								<tbody><tr>
									<td width="30%" style="padding:0;">
										 <div id="dacperioperatifpra_ttdid8" class="sigPad border border-dark" style="width:250px;">										  
											  <div class="sig sigWrapper border border-dark current" style="height: auto; display: block;">
												<canvas id="dacperioperatifpra_ttd8" class="pad" width="240" height="120"></canvas>
												<input id="dacperioperatifpra_codesig8" type="hidden" name="output-3" class="output" value="">
											  </div>
										</div>
									</td>
								  </tr>
						...
						<div class="col-md-12" align="center">
							<div class="col-md-10">
								<select id="dacperioperatifpra_apj8Id" class="form-control"></select>
							</div>
						</div>
						<div class="form-group row">
							 <div class="col-md-12" align="center">
						...
						<div class="form-group row">
							 <div align="center" class="col-md-12">
									<button id="dacperioperatifpra_btttd8" type="button" class="btn btn-sm btn-danger d-none"><!-- <i class="fas fa-signature"></i> --> Validasi</button>
							 </div>
						</div>
					</div>
					<div class="col-md-3">
						<div class="form-group row">
							<div class="col-md-12" align="center">
								<label class="col-form-label">Perawat Anestesi</label>
							</div>
						</div>
						<div class="form-group row d-none" id="dacperioperatifpra_divqrcode9">
							<div class="col-md-12" align="center">
								<img id="dacperioperatifpra_qrcode9">
							</div>
						</div>							
						<div class="table-responsive" align="center">
							<table class="table table-condensed d-none" style="width:250px; height: 120px;">
								<tbody><tr>
									<td width="30%" style="padding:0;">
										 <div id="dacperioperatifpra_ttdid9" class="sigPad border border-dark" style="width:250px;">										  
											  <div class="sig sigWrapper border border-dark current" style="height: auto; display: block;">
												<canvas id="dacperioperatifpra_ttd9" class="pad" width="240" height="120"></canvas>
												<input id="dacperioperatifpra_codesig9" type="hidden" name="output-3" class="output" value="">
											  </div>
										</div>
									</td>
								  </tr>
						...
						<div class="col-md-12" align="center">
							<div class="col-md-10">
								<select id="dacperioperatifpra_apj9Id" class="form-control"></select>
							</div>
						</div>
						<div class="form-group row">
							 <div class="col-md-12" align="center">
						...
						<div class="form-group row">
							 <div align="center" class="col-md-12">
									<button id="dacperioperatifpra_btttd9" type="button" class="btn btn-sm btn-danger d-none"><i class="fas fa-signature"></i>Validasi</button>
							 </div>
						</div>
					</div>
				</div>
			...
			<div class="card-footer">
				<button id="dacperioperatifpra_btsave2" type="button" class="btn btn-sm btn-primary"><i class="fas fa-save"></i>Simpan</button>
				<button id="dacperioperatifpra_btdelete2" type="button" class="btn btn-sm btn-danger" style="display:none;"><!-- <i class="fas fa-trash"></i> --> Hapus</button>
				<button id="dacperioperatifpra_btprint2" type="button" class="btn btn-sm btn-success" style="display:none;"><!-- <i class="fas fa-print"></i> --> Print PDF</button>
				<button id="dacperioperatifpra_btreset2" type="button" class="btn btn-sm btn-warning"><i class="fas fa-ban"></i>Reset</button>
			</div>		
		</div>
				...
				<div class="row ">
					<div class="col-md-6">
						<div class="form-group row">
							...
							<div class="col-md-3">
								<input id="dacperioperatifpra_id3" name="id3" type="text" class="form-control" readonly="readonly" value="0">
							</div>
							<div class="col-md-6">
	...
	<!-- 					</div> -->
		...
		<div class="card"><!-- SCORE PEMINDAHAN PASIEN --><!-- ???? -->
			<div class="card-header" style="background-color:black;">
							...
							<table class="table table-bordered table-condensed" width="100%">
								...
								<tr>
									<td width="30%" style="padding:3px;">
										...
										<div class="row" style="padding:3px;margin-inline-start: 15px">
											<div class="col-md-12  text-truncate">
												<div class="row" id="dacperioperatifpra_csuhan1">
													<div class="col-md-12">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
								...
								<tr>
									...
									<td width="20%" style="padding:3px;">
										...
										<div class="row" style="padding:3px;margin-inline-start: 15px">
											<div class="col-md-12 text-truncate">
												<div class="row" id="dacperioperatifpra_csuhan10">
													<div class="col-md-12">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
										...
										<div class="row" style="padding:3px;margin-inline-start: 15px">
											<div class="col-md-12 text-truncate">
												<div class="row" id="dacperioperatifpra_csuhan11">
													<div class="col-md-12">
														<div class="form-group">
															<div class="row custom-control custom-checkbox custom-control-inline">
								...
								<tr>
									<td width="30%" style="padding:3px;">
										...
										<div class="row" style="padding:3px;margin-inline-start: 15px">
											<div class="col-md-12  text-truncate">
												<div class="row" id="dacperioperatifpra_csuhan12">
													<div class="col-md-12">
														<div class="form-group">
															<div class="row custom-control custom-checkbox custom-control-inline">
										...
										<div class="row" style="padding:3px;margin-inline-start: 15px">
											<div class="col-md-12  text-truncate">
												<div class="row" id="dacperioperatifpra_csuhan13">
													<div class="col-md-12">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
									...
									<td width="30%" style="padding:3px;">
										...
										<div class="row" style="padding:3px;margin-inline-end: 15px">
											<div class="col-md-12 text-truncate">
												<div class="row" id="dacperioperatifpra_csuhan15">
													<div class="col-md-12">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
									...
									<td width="20%" style="padding:3px;">
										...
										<div class="row" style="padding:3px;margin-inline-start: 15px">
											<div class="col-md-12  text-truncate">
												<div class="row" id="dacperioperatifpra_csuhan16">
													<div class="col-md-12">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
										...
										<div class="row" style="padding:3px;margin-inline-start: 15px">
											<div class="col-md-12 text-truncate">
												<div class="row" id="dacperioperatifpra_csuhan17">
													<div class="col-md-12">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
										...
										<div class="row" style="padding:3px;margin-inline-start: 15px">
											<div class="col-md-12 text-truncate">
												<div class="row" id="dacperioperatifpra_csuhan18">
													<div class="col-md-12">
														<div class="form-group">
															<div class="row custom-control custom-radio custom-control-inline">
										...
										<div class="row" style="padding:3px;margin-inline-start: 15px">
											<div class="col-md-12 text-truncate">
												<div class="row" id="dacperioperatifpra_csuhan19">
													<div class="col-md-12">
														<div class="form-group">
															<div class="row custom-control custom-checkbox custom-control-inline">
		...
		<div class="card"><!-- TTD DOKTER PERAWAT -->
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="form-group row d-none" id="dacperioperatifpra_divqrcode10">
							<div class="col-md-12" align="center">
								<img id="dacperioperatifpra_qrcode10">
							</div>
						</div>							
						<div class="table-responsive" align="center">
							<table class="table table-condensed d-none" style="width:250px; height: 120px;">
								<tbody>
								  <tr>
									<td width="30%" style="padding:0;">
										 <div id="dacperioperatifpra_ttdid10" class="sigPad border border-dark" style="width:250px;">
											  <div class="sig sigWrapper border border-dark current" style="height: auto; display: block;">
												<canvas id="dacperioperatifpra_ttd10" class="pad" width="240" height="120"></canvas>
												<input id="dacperioperatifpra_codesig10" type="hidden" name="output-3" class="output" value="">
											  </div>
										</div>
									</td>
								  </tr>
						...
						<div class="form-group row">
							 <div align="center" class="col-md-12">
								<button id="dacperioperatifpra_btttd10" type="button" class="btn btn-sm btn-danger d-none"><!-- <i class="fas fa-signature"></i> --> Validasi</button>
							 </div>
						</div>
					</div>
					<div class="col-md-6">
						...
						<div class="form-group row d-none" id="dacperioperatifpra_divqrcode11">
							<div class="col-md-12" align="center">
								<img id="dacperioperatifpra_qrcode11">
							</div>
						</div>							
						<div class="table-responsive" align="center">
							<table class="table table-condensed d-none" style="width:250px; height: 120px;">
								<tbody>
								  <tr>
									<td width="30%" style="padding:0;">
										 <div id="dacperioperatifpra_ttdid11" class="sigPad border border-dark" style="width:250px;">
											  <a id="dacperioperatifpra_resetttd11" class="clearButton btn btn-primary " href="#clear" hidden="true" style="display: block;">Reset</a>
											  <div class="sig sigWrapper border border-dark current" style="height: auto; display: block;">
												<canvas id="dacperioperatifpra_ttd11" class="pad" width="240" height="120"></canvas>
												<input id="dacperioperatifpra_codesig11" type="hidden" name="output-3" class="output" value="">
											  </div>
										</div>
									</td>
								  </tr>
						...
						<div class="form-group row">
							 <div align="center" class="col-md-12">
								<button id="dacperioperatifpra_btttd11" type="button" class="btn btn-sm btn-danger d-none"><!-- <i class="fas fa-signature"></i> --> Validasi</button>
							 </div>
						</div>
					</div>
				</div>
			...
			<div class="card-footer">
				<button id="dacperioperatifpra_btsave3" type="button" class="btn btn-sm btn-primary"><!-- <i class="fas fa-save"></i> --> Simpan</button>
				<button id="dacperioperatifpra_btdelete3" type="button" class="btn btn-sm btn-danger" style="display:none;"><!-- <i class="fas fa-trash"></i> --> Hapus</button>
				<button id="dacperioperatifpra_btprint3" type="button" class="btn btn-sm btn-success" style="display:none;"><!-- <i class="fas fa-print"></i> --> Print PDF</button>
				<button id="dacperioperatifpra_btreset3" type="button" class="btn btn-sm btn-warning"><!-- <i class="fas fa-ban"></i> --> Reset</button>
			</div>
		</div>
...
function saveAsuhanPerioperatif(argument) {
...
$(document).on('keyup', '#normpas_preoperasi', function(e) {
	if($(this).val() !== '')
	{
		...
		if (hasil['data'] !== null) {
			if (hasil['code'] == 'XX') {
				...
				for (var i = 0; i < a.length; i++) {
					...
					Baris += '<i class="fa fa-user"></i>';
					Baris += '</div>';
					Baris += '<a href="#" class="small-box-footer" style="background-color: darkgreen;" onclick="viewFormPriope('+"'"+norm+"','"+nama_unit+"','"+kunjungan+"','"+id_unit+"','"+nama+"','"+transaksi+"','"+tgl_lahir+"','"+alamat+"'"+')">Klik Detail <i class="fas fa-arrow-circle-right"></i></a>';
					Baris += '</div>';
					Baris += '</div>';
				}
				// console.log(Baris);
...
function viewFormPriope(norm,nama_unit,kunjungan,id_unit,nam,transaksi,tgl_lahir,alamat){
...
function savePraOperasi(){
	if($('#dacperioperatifpra_asuhan8').checked){
		kolab=1;
	}else{
		kolab=0;
	}
	if($('#dacperioperatifpra_asuhan16').checked){
		edu_kolab=1;
	}else{
		edu_kolab=0;
	}
	...
	var params={
		id_kunjungan:'257',
		hub_ansietas:$('input[name=dacperioperatifpra_asuhan1]:checked').val(),
		bukti_ansietas:$('input[name=dacperioperatifpra_asuhan2]:checked').val(),
		ansietas_intervensi:$('#dacperioperatifpra_asuhan3').val(),
		hasil_ansietas:$('input[name=dacperioperatifpra_asuhan4]:checked').val(),
		observasi_ansietas:$('input[name=dacperioperatifpra_asuhan5]:checked').val(),
		terapeutik_ansietas:$('input[name=dacperioperatifpra_asuhan6]:checked').val(),
		edukasi_ansietas:$('input[name=dacperioperatifpra_asuhan7]:checked').val(),
		kolab_ansietas:kolab,
		hub_pengetahuan:$('input[name=dacperioperatifpra_asuhan9]:checked').val(),
		bukti_pengetahuan:$('input[name=dacperioperatifpra_asuhan10]:checked').val(),
		pengetahuan_intervensi:$('#dacperioperatifpra_asuhan11').val(),
		hasil_pengetahuan:$('input[name=dacperioperatifpra_asuhan12]:checked').val(),
		observasi_ilmu:$('input[name=dacperioperatifpra_asuhan13]:checked').val(),
		terapeutik_ilmu:$('input[name=dacperioperatifpra_asuhan14]:checked').val(),
		edukasi_ilmu:$('input[name=dacperioperatifpra_asuhan15]:checked').val(),
		kolab_ilmu:edu_kolab,
		hipotermia:$('input[name=dacperioperatifpra_asuhan17]:checked').val(),
		hipo_intervensi:$('#dacperioperatifpra_asuhan18').val(),
		hasil_hipo:$('input[name=dacperioperatifpra_asuhan19]:checked').val(),
		observasi_hipo:$('input[name=dacperioperatifpra_asuhan20]:checked').val(),
		terapeutik_hipo:$('input[name=dacperioperatifpra_asuhan21]:checked').val()
	};
...
function saveKeadaanPas3(){
	if($('input[name=dacperioperatifpra_sadar]:checked').val()==4){
		sdar=$('#dacperioperatifpra_sadarket').val();
	}else{
		sdar=$('input[name=dacperioperatifpra_sadar]:checked').val();
	};
	if($('input[name=dacperioperatifpra_emosi]:checked').val()==4){
	...
	if($('input[name=dacperioperatifpra_touryesno]:checked').val()==2){
		...
		torni=$('input[name=dacperioperatifpra_touryesno]:checked').val();
	};
	if($('input[name=dacperioperatifpra_implant]:checked').val()==2){
		mplan=$('#dacperioperatifpra_implantjenis').val()+','+$('#dacperioperatifpra_implantlokasi').val();
	}else{
		mplan=$('input[name=dacperioperatifpra_implant]:checked').val();
	};
	if($('input[name=dacperioperatifpra_drain]:checked').val()==2){
		drn=$('#dacperioperatifpra_tamponlokasi').val()+','+$('#dacperioperatifpra_tamponjumlah').val();
	}else{
	...
	if($('input[name=dacperioperatifpra_tampon]:checked').val()==2){
		tmpon=$('#dacperioperatifpra_drainjenis').val()+','+$('#dacperioperatifpra_drainlokasi').val();
	}else{
	...
	if($('input[name=dacperioperatifpra_spesimenyesno]:checked').val()==2){
		spesi_jar=$('input[name=dacperioperatifpra_spesimen]:checked').val()+','+$('#dacperioperatifpra_spesimenket').val();
	}else{
	...
	var params={
		...
		insisi:$('input[name=dacperioperatifpra_insisijml]:checked').val(),
		diatermi:termi,
...
function saveIntraOperasi(){
	var params={
		id_kunjungan:'258',
		pendarahan:$('input[name=dacperioperatifpra_bsuhan1]:checked').val(),
		intervensi_darah:$('#dacperioperatifpra_bsuhan2').val(),
		intervensi_hasil_darah:$('input[name=dacperioperatifpra_bsuhan3]:checked').val(),
		observasi_darah:$('input[name=dacperioperatifpra_bsuhan4]:checked').val(),
		terapeutik_darah:$('input[name=dacperioperatifpra_bsuhan5]:checked').val(),
		aspirasi:$('input[name=dacperioperatifpra_bsuhan6]:checked').val(),
		intervensi_aspirasi:$('#dacperioperatifpra_bsuhan7').val(),
		intervensi_hasil_aspirasi:$('input[name=dacperioperatifpra_bsuhan8]:checked').val(),
		observasi_aspirasi:$('input[name=dacperioperatifpra_bsuhan9]:checked').val(),
		terapeutik_aspirasi:$('input[name=dacperioperatifpra_bsuhan10]:checked').val(),
		hipotermia:$('input[name=dacperioperatifpra_bsuhan11]:checked').val(),
		intervensi_hipo:$('#dacperioperatifpra_bsuhan12').val(),
		intervensi_hasil_hipo:$('input[name=dacperioperatifpra_bsuhan13]:checked').val(),
		observasi_hipo:$('input[name=dacperioperatifpra_bsuhan14]:checked').val(),
		terapeutik_hipo:$('input[name=dacperioperatifpra_bsuhan15]:checked').val()
	};
...
function saveKeadaanPas4(){
	...
	if($('input[name=dacperioperatifpra_perdarahan]:checked').val()==2){
		darah=$('#dacperioperatifpra_perdarahanjumlah').val()+','+$('#dacperioperatifpra_perdarahanlokasi').val();
	}else{
		darah=$('input[name=dacperioperatifpra_perdarahan]:checked').val();
	}
	if($('input[name=dacperioperatifpra_muntah]:checked').val()==2){
		mntah=$('#dacperioperatifpra_muntahket').val();
	}else{
	...
	var params={
		...
		muntah:mntah,
		nyeri:nyri,
		jatuh:$('input[name=dacperioperatifpra_posisipx]:checked').val(),
		jaringan:jar
	};
...
function savePindahPas(){
	var params={
		id_kunjungan:'233',
		aldrete:document.getElementById('dacperioperatifpra_skorctot').innerHTML,
		bromage:document.getElementById('dacperioperatifpra_skorctot2').innerHTML,
		steward:document.getElementById('dacperioperatifpra_skorctot3').innerHTML,
	};
...
function savePascaOperasi(){
	...
	var params={
		id_kunjungan:'233',
		shok:$('input[name=dacperioperatifpra_csuhan1]:checked').val(),
		lama_shok:$('#dacperioperatifpra_csuhan2').val(),
		hasil_shok:$('input[name=dacperioperatifpra_csuhan3]:checked').val(),
		observasi_shok:$('input[name=dacperioperatifpra_csuhan4]:checked').val(),
		terapeutik_shok:$('input[name=dacperioperatifpra_csuhan5]:checked').val(),
		cairan:$('input[name=dacperioperatifpra_csuhan6]:checked').val(),
		lama_cairan:$('#dacperioperatifpra_csuhan7').val(),
		hasil_cairan:$('input[name=dacperioperatifpra_csuhan8]:checked').val(),
		observasi_cairan:$('input[name=dacperioperatifpra_csuhan9]:checked').val(),
		terapeutik_cairan:$('input[name=dacperioperatifpra_csuhan10]:checked').val(),
		kolab_cairan:cair,
		nyeri_hub:syok,
		nyeri_bukti:$('input[name=dacperioperatifpra_csuhan13]:checked').val(),
		lama_nyeri:$('#dacperioperatifpra_csuhan14').val(),
		hasil_nyeri:$('input[name=dacperioperatifpra_csuhan15]:checked').val(),
		observasi_nyeri:$('input[name=dacperioperatifpra_csuhan16]:checked').val(),
		terapeutik_nyeri:$('input[name=dacperioperatifpra_csuhan17]:checked').val(),
		edukasi_nyeri:$('input[name=dacperioperatifpra_csuhan18]:checked').val(),
		kolab_nyeri:nyeri,
	};
...
function savePostoperasi(){
	...
	if(document.getElementById('dacperioperatifpra_darah').checked){
		drah=$('#dacperioperatifpra_darahjumlah').val()+','+$('#dacperioperatifpra_darahlokasi').val();
	}else{
		drah=$('input[name=dacperioperatifpra_jatuhd]:checked').val();
	}
